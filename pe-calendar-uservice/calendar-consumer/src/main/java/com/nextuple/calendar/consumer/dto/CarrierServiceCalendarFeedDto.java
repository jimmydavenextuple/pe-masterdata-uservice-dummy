...
@AllArgsConstructor
@SuperBuilder
public class CarrierServiceCalendarFeedDto extends CommonMasterDataFieldsDto
    implements Serializable {

  private static final long serialVersionUID = -3358708299144961854L;
  ...
  @Schema(description = SHIPPING_STAGE, example = SHIPPING_STAGE_EXAMPLE)
