...
public class NodeCalendarConsumer extends MasterDataFeedConsumer<NodeCalendarFeedDto> {
  ...
  private final TypeReference<List<BatchRequest<NodeCalendarFeedDto>>> nodeCalendarTypeReference =
      new TypeReference<>() {};
  ...
  public void invokeFeedProcessingService(
      List<BatchRequest<NodeCalendarFeedDto>> nodeCalendarFeed) {
    nodeCalendarBatchService.processRecordsWithRetry(nodeCalendarFeed);
  }
