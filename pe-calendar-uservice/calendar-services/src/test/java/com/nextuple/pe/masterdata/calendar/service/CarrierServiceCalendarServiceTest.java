...
class CarrierServiceCalendarServiceTest {
  ...
  void processCreateCarrierServiceCalendarTest()
    ...
    when(carrierServiceCalendarPersistenceService.saveCarrierServiceCalendar(any()))
    ...
    verify(carrierServiceCalendarPersistenceService, times(1)).saveCarrierServiceCalendar(any());
  }
  ...
  void createNodeCalendarTestException() throws CalendarDomainException, CommonServiceException {
    ...
    when(carrierServiceCalendarPersistenceService
            .findByCalendarIdAndOrgIdAndCarrierServiceIdAndShippingStageAndEffectiveDate(
                any(), any(), any(), any(), any()))
        .thenReturn(Optional.of(testUtil.getCarrierServiceCalendarDomainDto()));
    ...
    verify(carrierServiceCalendarPersistenceService, times(1))
        .findByCalendarIdAndOrgIdAndCarrierServiceIdAndShippingStageAndEffectiveDate(
            any(), any(), any(), any(), any());
    verify(carrierServiceCalendarPersistenceService, times(0)).saveCarrierServiceCalendar(any());
  }
  ...
  void processGetCarrierServiceCalendarWithServiceOptionTest()
    ...
    when(carrierServiceCalendarPersistenceService.getCarrierServiceCalendar(
            any(), any(), any(), any()))
        .thenReturn(Collections.singletonList(testUtil.getCarrierServiceCalendarDomainDto()));
  ...
  void processGetCarrierServiceCalendarTest()
      throws CalendarDomainException, CalenderServiceException {
    when(carrierServiceCalendarPersistenceService.getCarrierServiceCalendar(any(), any(), any()))
        .thenReturn(Collections.singletonList(testUtil.getCarrierServiceCalendarDomainDto()));
    ...
    Assertions.assertEquals(
        TestUtil.DESCRIPTION, Objects.requireNonNull(resp.get(0).getDescription()));
    verify(carrierServiceCalendarPersistenceService, times(1))
        .getCarrierServiceCalendar(any(), any(), any());
  }
  ...
  void getAllCarrierCalendarCacheKeysTest() throws CalendarDomainException {
    List<CarrierServiceCalendarDomainDto> carrierServiceCalendarDomainDtos =
        testUtil.getCarrierServiceCalendarDomainDtoList();

    when(carrierServiceCalendarPersistenceService.getAllCarrierServiceCalendars(any()))
        .thenReturn(carrierServiceCalendarDomainDtos);
    ...
    Assertions.assertEquals(
        carrierServiceCalendarDomainDtos.get(0).getCarrierServiceId(),
        response.get(0).getCarrierServiceId());
    verify(carrierServiceCalendarPersistenceService, times(1)).getAllCarrierServiceCalendars(any());
  }

  @Test
  void getCarrierServiceAssociationWithCalendarTest() throws CalendarDomainException {
    when(carrierServiceCalendarPersistenceService.getCarrierServiceCalendarByOrgIdAndCalendarId(
            any(), any()))
        .thenReturn(
            List.of(
