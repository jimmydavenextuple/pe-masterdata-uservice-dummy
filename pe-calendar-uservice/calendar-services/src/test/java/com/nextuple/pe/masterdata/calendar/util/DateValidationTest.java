...
class DateValidationTest {
  ...
  @Test
  @DisplayName("Add days to given date")
  void addDaysToGivenDate() {
    String date = DateUtil.addDaysToGivenDate(Optional.of("2024-01-01"), 1);
    Assertions.assertEquals("2024-01-02", date);
    date = DateUtil.addDaysToGivenDate(Optional.empty(), 1);
