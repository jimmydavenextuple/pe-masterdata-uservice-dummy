...
class UEConfigDataNearCacheServiceImplTest {

  @InjectMocks private UEConfigDataNearCacheServiceImpl ueConfigDataNearCacheService;

  @InjectMocks private TestUtil testUtil;

  @Mock
  private GenericFeignCacheService<UEConfigDataCacheKey, UEConfigDataCacheValue> feignCacheService;
  ...
  void getTestForValidData() {
    ...
    // First Invocation
    CacheValue cacheValue1 = ueConfigDataNearCacheService.get(cacheKey);
  ...
  void getTestForInValidData() {
    ...
    assertNull(ueConfigDataNearCacheService.get(cacheKey));
    verify(feignCacheService, times(1)).get(cacheKey);
  }
  ...
  void deleteTest() {
    UEConfigDataCacheKey cacheKey = testUtil.getUEConfigDataCacheKey();
    ueConfigDataNearCacheService.delete(cacheKey);
    CacheValue cacheValue = ueConfigDataNearCacheService.get(cacheKey);
  ...
  void deleteAllTest() {
    UEConfigDataCacheKey cacheKey = testUtil.getUEConfigDataCacheKey();
    ueConfigDataNearCacheService.deleteAll();
    CacheValue cacheValue = ueConfigDataNearCacheService.get(cacheKey);
    assertNull(cacheValue);
  }
  ...
  void selfRegister() {
    ...
    ueConfigDataNearCacheService.selfRegister();
  ...
  void getEntityName() {
    assertEquals(
        ...
        ueConfigDataNearCacheService.getEntityName());
  }
}
