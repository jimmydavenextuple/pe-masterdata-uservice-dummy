...
public interface OptimizationStrategyFeignImpl
    extends GenericFeignService<String, BaseResponse<DetailedOptimizationStrategyResponse>> {

  @GetMapping("/optimization-strategy/get")
  BaseResponse<DetailedOptimizationStrategyResponse> get(String request);

  @GetMapping("/named-optimization-strategy/orgId/{orgId}/groupId/{groupId}")
  BaseResponse<DetailedOptimizationStrategyResponse> getOptimizationStrategyByOrgIdAndGroupId(
