...
public interface RulesConfigurationFeign
    extends GenericFeignService<String, BaseResponse<RulesConfigurationResponse>> {

  @GetMapping("/get")
  BaseResponse<RulesConfigurationResponse> get(String request);

  @PostMapping("/rules-configuration/fetch-rule")
  BaseResponse<RulesConfigurationResponse> fetchRulesConfiguration(
      @RequestBody FetchRuleConfigurationRequest fetchRuleConfigurationRequest);
}
