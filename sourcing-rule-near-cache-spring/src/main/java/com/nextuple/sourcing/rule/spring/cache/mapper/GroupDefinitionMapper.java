...
public class GroupDefinitionMapper
  ...
  @Override
  public GroupDefinitionCacheKey requestToCacheKey(String request) {
    return null;
  }

  @Override
  public String cacheKeyToRequest(GroupDefinitionCacheKey cacheKey) {
    return null;
  }

  @Override
  public GroupDefinitionCacheValue responseToCacheValue(
      BaseResponse<GroupDefinitionListResponse> resp) {
    return GroupDefinitionCacheValue.builder()
        .groupDefinitionListResponse(resp.getPayload())
        .build();
  }

  @Override
  public BaseResponse<GroupDefinitionListResponse> cacheValueToResponse(
      GroupDefinitionCacheValue cacheValue) {
    return null;
  }
}
