...
@Inherited
@Operation(
    summary = "Get Zip Code Timezone",
    description =
        "Retrieves the zip code timezone details for the given organization ID and zip code prefix.")
@ApiResponse(
    responseCode = "200",
    description =
        "A 200 success code indicates that the zip code timezone details are retrieved successfully.")
@ApiResponse(
    responseCode = "400",
    description =
...
public @interface GetPostalCodeTimezoneDetails {}
