...
@Inherited
@Operation(
    summary = "Deleting zip code details",
    description = "Deletes the zip code details of given zip code.")
@ApiResponse(
    responseCode = "200",
    description =
        "A 200 success code indicates that zip code details of given zip code are successfully deleted.")
@ApiResponse(
    responseCode = "404",
    description =
...
public @interface DeletePostalCodeDetails {}
