...
public interface PostalCodeTimezoneMapper {
  PostalCodeTimezoneDomainDto convertToPostalCodeTimezoneEntity(
  ...
  PostalCodeTimezoneDomainDto convertFromCreatePostalCodeTimezoneRequestToEntity(
  ...
  void insertValuesFromUpdatePostalCodeTimezoneRequestToEntity(
      ...
      @MappingTarget PostalCodeTimezoneDomainDto postalCodeTimezoneDomainDto);
}
