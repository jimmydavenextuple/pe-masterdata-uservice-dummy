...
@Inherited
@Operation(
    summary = "Delete Weightage Configuration",
    description =
        "Deletes the weightage configuration details for the given organization ID, configuration type and key.")
@ApiResponse(
    responseCode = "200",
    description =
        "A 200 success code indicates that the weightage configuration is deleted successfully.")
@ApiResponse(
    responseCode = "400",
    description =
            ...
            examples = {
              ...
              @ExampleObject(
                  ...
                  value =
                      "{\n"
                          + "    \"success\": false,\n"
                          + "    \"requestId\": \"db8b5231-9ee1-4014-bc0e-c4b55e4d5c5c#1907\",\n"
                          + "    \"timestamp\": 1679906852979,\n"
                          + "    \"message\": \"Bad Request\",\n"
                          + "    \"payload\": {\n"
                          + "        \"type\": \"ERROR\",\n"
                          + "        \"code\": 2,\n"
                          ...
                          + "            \"key\": {\n"
                          + "                \"rejectedValue\": \"\",\n"
                          + "                \"errorMessage\": \"key can't be empty\"\n"
                          + "            }\n"
                          + "        }\n"
                          + "    }\n"
                          + "}")
...
public @interface DeleteWeightageConfigurationDoc {}
