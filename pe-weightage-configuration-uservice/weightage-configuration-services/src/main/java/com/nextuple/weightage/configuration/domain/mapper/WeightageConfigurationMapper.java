...
public interface WeightageConfigurationMapper {
  WeightageConfigurationDomainDto convertToWeightageConfigurationDomainDto(
  ...
  WeightageConfigurationDomainDto
      convertCreateWeightageConfigurationRequestToWeightageConfigurationDomainDto(
  ...
  void insertValuesFromUpdateWeightageConfigurationRequestToDomainDto(
      ...
      @MappingTarget WeightageConfigurationDomainDto weightageConfigurationDomainDto);
