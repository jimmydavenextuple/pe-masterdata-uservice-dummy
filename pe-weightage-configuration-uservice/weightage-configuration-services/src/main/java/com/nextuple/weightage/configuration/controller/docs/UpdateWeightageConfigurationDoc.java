...
@Inherited
@Operation(
    summary = "Update Weightage Configuration",
    description =
        "Updates the weightage configuration details for the given organization ID, configuration type and key.")
@ApiResponse(
    responseCode = "200",
    description =
        "A 200 success code indicates that the weightage configuration is updated successfully.")
@ApiResponse(
    responseCode = "400",
    description =
...
public @interface UpdateWeightageConfigurationDoc {}
