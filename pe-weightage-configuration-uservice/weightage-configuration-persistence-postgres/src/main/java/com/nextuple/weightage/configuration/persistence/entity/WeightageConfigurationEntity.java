...
package com.nextuple.weightage.configuration.persistence.entity;
...
@Entity
@IdClass(WeightageConfigurationKey.class)
@Data
@NoArgsConstructor
@SuperBuilder
@Table(
...
public class WeightageConfigurationEntity extends CommonBaseEntity {
