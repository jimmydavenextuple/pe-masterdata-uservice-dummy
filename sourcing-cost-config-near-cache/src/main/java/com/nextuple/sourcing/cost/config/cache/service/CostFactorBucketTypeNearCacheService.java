...
package com.nextuple.sourcing.cost.config.cache.service;
...
public interface CostFactorBucketTypeNearCacheService
    extends GenericNearCacheService<CostFactorBucketTypeCacheKey, CostFactorBucketTypeCacheValue> {}
