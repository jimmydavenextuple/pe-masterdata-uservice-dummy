...
public interface NodeGroupMapper {
  ...
  NodeGroupDomainDto toNodeGroupEntity(CreateNodeGroupRequest nodeGroupRequest);

  NodeGroupResponse toNodeGroupResponse(NodeGroupDomainDto nodeGroupDomainDto);

  void updateNodeGroupEntity(
      UpdateNodeGroupRequest updateNodeGroupRequest,
      @MappingTarget NodeGroupDomainDto nodeGroupDomainDto);
}
