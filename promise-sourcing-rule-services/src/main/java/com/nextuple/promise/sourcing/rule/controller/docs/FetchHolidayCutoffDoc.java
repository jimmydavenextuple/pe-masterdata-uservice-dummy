...
@Inherited
@Operation(
    summary = "Fetch Holiday Cutoff",
    description = "Fetches holiday cutoff data for given details.")
@ApiResponse(
    responseCode = "200",
    description =
        "A 200 status code indicates that the holiday cutoff data is successfully fetched.",
    content =
        @Content(
            schema = @Schema(implementation = HolidayCutoffRulesResponse.class),
            examples = {
              @ExampleObject(
                  summary = "Holiday cutoff data fetched successfully!",
                  name = "Holiday cutoff fetched",
                  value =
                      """
                                                                        {
                                                                            "success": true,
...
public @interface FetchHolidayCutoffDoc {}
