...
public interface RulesConfigurationMapper {

  RulesConfigurationDomainDto toRulesConfigurationDomainDto(
      RulesConfigurationsRequest rulesConfigurationsRequest);

  RulesConfigurationResponse toRulesConfigurationResponse(
      RulesConfigurationDomainDto rulesConfigurationDomainDto);
}
