 ...
 */
package com.nextuple.postal.code.timezone.persistence.mapper;
...
public interface CustomRegionEntityMapper
    extends DomainToEntityMapper<
        CustomRegionDomainDto, CustomRegionDomainKey, CustomRegionEntity, CustomRegionKey> {}
