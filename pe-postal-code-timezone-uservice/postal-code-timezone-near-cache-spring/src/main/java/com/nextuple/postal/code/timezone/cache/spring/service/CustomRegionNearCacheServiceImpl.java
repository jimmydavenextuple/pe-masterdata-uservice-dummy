...
public class CustomRegionNearCacheServiceImpl
    ...
    implements CustomRegionNearCacheService {

  private static final Logger logger =
      LoggerFactory.getLogger(CustomRegionNearCacheServiceImpl.class);

  public static final String CUSTOM_REGION_CACHE_NAME = "custom_region";
  ...
  public void selfRegister() {
    nearCacheRegistry.registerNearCacheEntity(
        ...
        CustomRegionCacheKey.class.getName(),
        "full");
  }

  @Override
  public String getEntityName() {
    return NearCacheConstants.SOURCING_CUSTOM_REGION_ENTITY_NAME;
  }

  @Override
  public CustomRegionCacheValue get(CustomRegionCacheKey key) {
    logger.debug("Inside get CustomRegionCacheValue");
    return super.get(key);
  }

  @Override
  public String getCacheName() {
    return CUSTOM_REGION_CACHE_NAME;
  }
}
