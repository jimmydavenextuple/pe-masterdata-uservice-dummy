...
public interface DataMapper {
  PostalCodeCacheValue toPostalCodeCacheValue(PostalCodeResponse postalCodeResponse);

  CustomRegionCacheValue toCustomRegionCacheValue(CustomRegionResponse customRegionResponse);
}
