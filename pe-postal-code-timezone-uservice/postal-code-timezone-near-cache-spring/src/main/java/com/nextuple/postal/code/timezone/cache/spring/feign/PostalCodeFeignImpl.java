...
public interface PostalCodeFeignImpl
    extends GenericFeignService<String, BaseResponse<PostalCodeResponse>> {

  @GetMapping("/postal-code/get")
  BaseResponse<PostalCodeResponse> get(String request);
