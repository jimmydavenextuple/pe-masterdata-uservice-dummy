...
public interface CustomRegionFeignImpl
    extends GenericFeignService<String, BaseResponse<CustomRegionResponse>> {

  @GetMapping("/custom-region/get")
  BaseResponse<CustomRegionResponse> get(String request);
