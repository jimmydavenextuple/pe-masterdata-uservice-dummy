...
public interface PostalCodePersistenceService
  ...
  PostalCodeDomainDto savePostalCode(PostalCodeDomainDto postalCodeEntity)
      throws PromiseEngineException;

  Optional<PostalCodeDomainDto> fetchPostalCode(String orgId, String postalCode)
      throws PromiseEngineException;

  void deletePostalCodeEntity(PostalCodeDomainDto postalCodeEntity) throws PromiseEngineException;

  List<PostalCodeDomainDto> fetchPostalCodeList(String orgId, String postalCodePrefix)
      throws PromiseEngineException;

  List<MarketRegionProjection> getRecordsForOrgId(String orgId) throws PromiseEngineException;

  List<PostalCodeDomainDto> getPostCodeTimeZoneByOrgIdAndCountry(String orgId, String country)
      throws PromiseEngineException;

  List<String> getPostalCodePrefixForOrgIdAndState(String orgId, String state)
      throws PromiseEngineException;
