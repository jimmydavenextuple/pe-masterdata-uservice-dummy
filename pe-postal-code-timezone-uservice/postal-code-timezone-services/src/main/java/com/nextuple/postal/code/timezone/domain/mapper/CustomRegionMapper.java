...
public interface CustomRegionMapper {
  ...
  CustomRegionDomainDto toCustomRegionEntity(CustomRegionRequest createCustomRegionRequest);

  CustomRegionResponse toCustomRegionResponse(CustomRegionDomainDto customRegion);

  void updateCustomRegionEntity(
      CustomRegionRequest createCustomRegionRequest,
      @MappingTarget CustomRegionDomainDto customRegion);
