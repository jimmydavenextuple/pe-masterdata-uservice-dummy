...
@Inherited
@Operation(
    summary = "Update Zip Code Timezone",
    description =
        "Updates the zip code timezone details for the given organization ID and zip code prefix.")
@ApiResponse(
    responseCode = "200",
    description =
        "A 200 success code indicates that custom zip code timezone is updated successfully.")
@ApiResponse(
    responseCode = "400",
    description =
    ...
    content =
        @Content(
            ...
            examples = {
              ...
              @ExampleObject(
                  summary =
                      "Indicates that the required request parameter 'zipCodePrefix' for method parameter type String is not present.",
                  name =
                      "A 400 error code indicates that the required request parameter 'zipCodePrefix' for method parameter type String is not present.",
                  value =
                      "{\n"
                          + "    \"success\": false,\n"
...
public @interface UpdatePostalCodeTimezoneDetails {}
