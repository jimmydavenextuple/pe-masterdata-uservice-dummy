...
@Inherited
@Operation(
    summary = "Updating zip code details",
    description = "Updates the zip code details of given zip code.")
@ApiResponse(
    responseCode = "200",
    description =
        "A 200 success code indicates that zip code details for the given zip code are updated successfully.")
@ApiResponse(
    responseCode = "404",
    description =
...
public @interface UpdatePostalCodeDetails {}
