...
@Inherited
@Operation(
    summary = "Getting zip code details",
    description = "Retrieves the zip code details of given zip code.")
@ApiResponse(
    responseCode = "200",
    description =
        "A 200 success code indicates that zip code details for the given zip code is retrieved successfully.")
@ApiResponse(
    responseCode = "404",
    description =
...
public @interface GetPostalCodeDetails {}
