...
import com.hbc.postal.code.timezone.cache.spring.util.TestUtil;
...
class PostalCodeTimezoneNearCacheServiceImplTest {
  ...
  void selfRegister() {
    ...
    postalCodeTimezoneNearCacheServiceImpl.selfRegister();
  ...
  void getEntityName() {
    assertEquals(
        ...
        postalCodeTimezoneNearCacheServiceImpl.getEntityName());
  }
}
