package com.nextuple.common.kafka.config.util;
...
public class CommonKafkaUtil {
    ...
    public static Map<String, Object> flattenAndReplace(Map<String, Object> producer) {
        ...
        producer.entrySet().forEach(entry -> {
            if (entry.getValue() instanceof Map) {
                Map<String, Object> childMap = flattenAndReplace((Map<String, Object>) entry.getValue());
