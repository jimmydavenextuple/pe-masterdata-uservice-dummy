...
public class DestinationAddress implements Serializable {
  ...
  private static final long serialVersionUID = 7944777662207852120L;

  @Schema(description = "Destination address zipCode")
  @AttributePath(path = "/zipCode")
  private String zipCode;

  @Schema(description = "Destination address region")
  @AttributePath(path = "/region")
  private String region;

  @Schema(description = "Destination address state")
  @AttributePath(path = "/state")
  private String state;

  @Schema(description = "Destination address country")
  @AttributePath(path = "/country")
  private String country;

  @Schema(description = "Destination address timezone")
