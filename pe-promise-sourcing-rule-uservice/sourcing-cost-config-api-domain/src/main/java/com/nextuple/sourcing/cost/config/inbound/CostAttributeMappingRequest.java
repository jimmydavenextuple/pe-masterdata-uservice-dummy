...
@AllArgsConstructor
@NoArgsConstructor
public class CostAttributeMappingRequest extends AdditionalAttributes implements Serializable {
  private static final long serialVersionUID = -6482078974296281018L;

  @NotBlank(message = "Canonical Name can't be empty")
  @Schema(
  ...
  @NotBlank(message = "Product Attribute Name can't be empty")
