...
public interface CostAttributeDetailsFeign {
  @GetMapping("/cost-attribute/get-all-cache-keys")
  BaseResponse<List<CostAttributeDetailsCacheKeyDto>> getCostAttributeDetailsCacheKeys(
