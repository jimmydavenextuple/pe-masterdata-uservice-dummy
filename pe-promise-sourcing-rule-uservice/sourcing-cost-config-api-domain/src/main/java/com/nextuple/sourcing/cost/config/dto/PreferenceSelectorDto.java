...
@AllArgsConstructor
@NoArgsConstructor
public class PreferenceSelectorDto extends AdditionalAttributes implements Serializable {
  private static final long serialVersionUID = -3168905046833847043L;

  @Schema(description = "Unique identifier of the tenant preference for selector.", example = "1")
  private Long id;
