...
public interface CostItineraryAndFactorsFeign {
  @GetMapping(
      value =
  ...
  @GetMapping("/cost-config/cost-itinerary-factors-mapping/get-all-cache-keys")
  BaseResponse<List<CostItineraryAndFactorsCacheKeyDto>> getCostItineraryAndFactorsCacheKeys(
