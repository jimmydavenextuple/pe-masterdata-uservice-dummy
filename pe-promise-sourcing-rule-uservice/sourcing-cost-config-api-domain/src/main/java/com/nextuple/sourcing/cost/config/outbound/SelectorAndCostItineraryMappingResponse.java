...
@Builder
@NoArgsConstructor
public class SelectorAndCostItineraryMappingResponse implements Serializable {

  private static final long serialVersionUID = -7573422637404423313L;

  @Schema(description = "Unique identifier for selector and cost itinerary mapping.", example = "1")
  private long id;
  ...
  @Schema(description = "Specifies the cost itinerary.", example = "SHIPPING_COST_UPSLIKE")
