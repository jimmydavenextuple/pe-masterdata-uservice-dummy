...
public interface SelectorAndCostItineraryMappingFeign {
  ...
  @GetMapping("/cost-config/selector-itinerary-mapping/get-all-cache-keys")
  BaseResponse<List<SelectorAndCostItineraryMappingCacheKeyDto>>
      getSelectorAndCostItineraryCacheKeys(@NotNull @RequestParam Integer limit);
}
