...
public interface CostAttributeMappingFeign {
  @GetMapping("/cost-attribute-mapping/get-all-cache-keys")
  BaseResponse<List<CostAttributeMappingCacheKeyDto>> getCostAttributeMappingCacheKeys(
