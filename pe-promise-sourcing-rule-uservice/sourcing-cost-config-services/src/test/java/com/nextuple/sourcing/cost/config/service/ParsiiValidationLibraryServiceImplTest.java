...
class ParsiiValidationLibraryServiceImplTest {

  @InjectMocks private TestUtil testUtil;

  @InjectMocks private ParsiiValidationLibraryServiceImpl parsiiValidationLibraryService;
  ...
  @Test
  void validateFormulaTest() throws CommonServiceException, ParseException {
    Double formulaValue =
        parsiiValidationLibraryService.validateFormula(
  ...
  void validateFormulaExceptionTest() {
    ...
    assertEquals(
        "Exception while parsing formula via parsii ", exception.getMessage().split(":")[0]);
