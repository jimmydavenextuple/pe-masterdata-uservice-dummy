...
@Table(
    name = "cost_value",
    indexes = @Index(name = "cost_value_id_orgId", columnList = "id,org_id"))
public class CostValueEntity extends CommonBaseEntity {
  ...
  @Column(name = "cost_factor_combination_key ")
  private String costFactorCombinationKey;

  @Column(name = "cost_value")
  private Double costValue;

  @Column(name = "prev_slab_value")
