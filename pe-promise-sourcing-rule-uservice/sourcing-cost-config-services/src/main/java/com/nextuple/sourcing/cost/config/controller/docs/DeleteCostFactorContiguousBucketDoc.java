...
@Inherited
@Operation(
    summary = "Delete Cost Factors Contiguous Bucket",
    description = "Delete Cost Factors Contiguous Bucket for a given organization ID.")
@ApiResponse(
    responseCode = "200",
    description = "When Cost Factors Contiguous Bucket is successfully deleted.",
    content =
        @Content(
            schema = @Schema(implementation = CostFactorContiguousBucketDto.class),
            examples = {
              @ExampleObject(
                  summary = "When Cost Factors Contiguous Bucket is successfully deleted.",
                  name =
                      "A 200 response indicates that the Cost Factors Contiguous Bucket is successfully deleted.",
                  value =
                      """
                                            {
                                                   "success": true,
...
@ApiResponse(
    ...
    description =
        "<li><b>Error code: 6001 </b></li><ul>"
            + "<li> When a Contiguous bucket is not found for given Id and orgId combination.</li>"
            + "</ul>",
    content =
        @Content(
            ...
            examples = {
              @ExampleObject(
                  summary =
                      "When a Contiguous bucket is not found for given Id and orgId combination.",
                  name =
                      "A 404 response indicates that the Contiguous bucket is not found for given Id and orgId combination.",
                  value =
                      """
                                               {
                                                   "success": false,
                                                   "requestId": "638c1d95-d470-4d91-9da3-643ad741178c#13606",
                                                   "timestamp": 1702294553040,
...
public @interface DeleteCostFactorContiguousBucketDoc {}
