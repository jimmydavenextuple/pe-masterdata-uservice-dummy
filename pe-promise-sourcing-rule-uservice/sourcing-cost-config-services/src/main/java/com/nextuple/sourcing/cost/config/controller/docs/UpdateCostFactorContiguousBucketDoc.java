...
@Inherited
@Operation(
    summary = "Update Cost Factors Contiguous Bucket",
    description = "Updates the Cost Factors Contiguous Bucket details.")
@ApiResponse(
    responseCode = "200",
    description = "When Cost Factors Contiguous Bucket details are successfully updated.",
    content =
        @Content(
            schema = @Schema(implementation = CostFactorContiguousBucketDto.class),
            examples = {
              @ExampleObject(
                  summary = "When Cost Factors Contiguous Bucket details are successfully updated.",
                  name =
                      "A 200 response indicates that the Cost Factors Contiguous Bucket details are successfully updated.",
                  value =
                      """
                                            {
                                                   "success": true,
                                                   "requestId": "638c1d95-d470-4d91-9da3-643ad741178c#12123",
                                                   "timestamp": 1702293867130,
...
@ApiResponse(
    ...
    description =
        "<li><b>Error code: 6001 </b></li><ul>"
            + "<li> When a Contiguous bucket record is not found for the orgId and Id.</li>"
            + "</ul>",
    content =
        @Content(
            ...
            examples = {
              @ExampleObject(
                  summary = "When a Contiguous bucket record is not found for the orgId and Id.",
                  name =
                      "A 400 response indicates that the Contiguous bucket record is not found for the orgId and Id.",
                  value =
                      """
                                               {
                                                  "success": false,
                                                  "requestId": "638c1d95-d470-4d91-9da3-643ad741178c#12226",
                                                  "timestamp": 1702293890761,
...
@ApiResponse(
    ...
    content =
        @Content(
            ...
            examples = {
              @ExampleObject(
                  summary = "When Bucket type of cost factor is not CONTIGUOUS.",
                  name =
                      "A 400 response indicates that the Bucket type of cost factor is not CONTIGUOUS.",
                  value =
                      """
                                                {
                                                     "success": false,
                                                     "requestId": "ec3870af-8317-4a38-b685-067e77e5967f#11508",
                                                     "timestamp": 1702293334795,
                                                     "message": "Bucket type of cost factor should be CONTIGUOUS",
                                                     "payload": {
                                                         "type": "ERROR",
                                                         "code": 6001,
                                                         "fields": {
              ...
              @ExampleObject(
                  ...
                  value =
                      """
                                                {
                                                        "success": false,
                                                        "requestId": "29d6ec91-0ead-4bdb-aeb9-904f73f451a4#13002",
                                                        "timestamp": 1702294088574,
...
public @interface UpdateCostFactorContiguousBucketDoc {}
