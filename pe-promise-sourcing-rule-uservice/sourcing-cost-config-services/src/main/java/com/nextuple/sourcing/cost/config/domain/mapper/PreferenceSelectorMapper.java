...
public interface PreferenceSelectorMapper {
  PreferenceSelectorEntity toPreferenceSelectorEntity(
      CreatePreferenceSelectorRequest createPreferenceSelectorRequest);

  PreferenceSelectorDto toPreferenceSelectorDto(PreferenceSelectorEntity preferenceSelectorEntity);

  List<PreferenceSelectorCacheKeyDto> toPreferenceSelectorCacheKeyResponseList(
      List<PreferenceSelectorEntity> preferenceSelectorEntities);
}
