...
@Table(
    name = "cost_attribute_mapping",
    indexes = @Index(name = "cost_attribute_mapping_id_orgId", columnList = "id,org_id"))
public class CostAttributeMappingEntity extends CommonBaseEntity {
  @Id
