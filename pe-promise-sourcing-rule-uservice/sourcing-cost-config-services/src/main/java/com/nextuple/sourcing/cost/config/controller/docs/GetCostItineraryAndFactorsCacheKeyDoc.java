...
@Inherited
@Operation(
    summary = "Get Cost Itinerary And Cost Factors Mapping",
    description =
        "Retrieves the list of all the cache keys for Cost Itinerary And Cost Factors Mapping")
@ApiResponse(
    responseCode = "200",
    description =
        "When all the cache keys for Cost Itinerary And Cost Factors mapping are retrieved successfully.",
    content =
        @Content(
            ...
            examples = {
              @ExampleObject(
                  summary =
                      "When all the cache keys for Cost Itinerary And Cost Factors mapping are retrieved successfully.",
                  name =
                      "A 200 success code indicates that all the cache keys for Cost Itinerary And Cost Factors mapping are retrieved successfully.",
                  value =
                      "{\n"
                          + "    \"success\": true,\n"
                          + "    \"requestId\": \"f73e4262-7608-4df5-bac4-cc1150e49e89#547\",\n"
                          + "    \"timestamp\": 1702029872161,\n"
                          + "    \"message\": \"Cost Itinerary And Factors Keys fetched successfully\",\n"
                          + "    \"payload\": [\n"
                          + "        {\n"
                          + "            \"orgId\": \"XYZINC\",\n"
                          + "            \"costItinerary\": \"node_proceeing_itinerary\",\n"
                          + "            \"itineraryStatus\": \"CREATED\",\n"
                          + "            \"isActive\": true\n"
                          + "        },\n"
                          + "        {\n"
                          + "            \"orgId\": \"XYZINC\",\n"
                          + "            \"costItinerary\": \"fedex_ground_itinerary_shipping\",\n"
                          + "            \"itineraryStatus\": \"CREATED\",\n"
                          + "            \"isActive\": true\n"
                          + "        },\n"
                          + "        {\n"
                          + "            \"orgId\": \"XYZINC\",\n"
                          + "            \"costItinerary\": \"ups_ground_itinerary_shipping\",\n"
                          + "            \"itineraryStatus\": \"CREATED\",\n"
                          + "            \"isActive\": true\n"
                          + "        }\n"
                          + "    ]\n"
...
public @interface GetCostItineraryAndFactorsCacheKeyDoc {}
