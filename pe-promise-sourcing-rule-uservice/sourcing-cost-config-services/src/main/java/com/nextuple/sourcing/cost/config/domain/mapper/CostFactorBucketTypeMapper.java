...
public interface CostFactorBucketTypeMapper {
  CostFactorBucketTypeDto convertCostTypeBucketEntityToCostTypeBucketDto(
      CostFactorBucketTypeEntity costFactorBucketTypeEntity);

  CostFactorBucketTypeEntity convertRequestToCostFactorBucketTypeEntity(
      CostFactorBucketTypeRequest request);

  List<CostFactorBucketTypeCacheKeyDto> toCostFactorBucketTypeCacheKeyResponseList(
