...
@Inherited
@Operation(
    summary = "Delete Optimization And Cost Types Mapping",
    description = "Deletes Optimization And Cost Types Mapping Service By Organization ID And ID.")
@ApiResponse(
    responseCode = "200",
    description =
        "A 200 success code indicates that the Optimization And Cost Types Mapping is successfully deleted.",
    content =
        @Content(
            schema = @Schema(implementation = OptimizationAndCostTypesMappingResponse.class),
            examples = {
              @ExampleObject(
                  summary = "Optimization And Cost Types Mapping is successfully deleted.",
                  name = "Optimization And Cost Types Mapping is deleted.",
                  value =
                      """
                                                        {
                                                              "success": true,
...
public @interface DeleteOptimizationAndCostTypesMappingByOrgIdAndIdDoc {}
