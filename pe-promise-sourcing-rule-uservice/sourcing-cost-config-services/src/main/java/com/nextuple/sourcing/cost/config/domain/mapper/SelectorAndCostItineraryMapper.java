...
public interface SelectorAndCostItineraryMapper {

  SelectorAndCostItineraryMappingEntity toSelectorAndCostItineraryMappingEntity(
      SelectorAndCostItineraryMappingRequest selectorAndCostItineraryMappingRequest);

  SelectorAndCostItineraryMappingResponse toSelectorAndCostItineraryMappingResponse(
      SelectorAndCostItineraryMappingEntity selectorAndCostItineraryMappingEntity);

  List<SelectorAndCostItineraryMappingResponse> toSelectorAndCostItineraryMappingListResponse(
      List<SelectorAndCostItineraryMappingEntity> selectorAndCostItineraryMappingEntityList);

  List<SelectorAndCostItineraryMappingCacheKeyDto> toSelectorAndCostItineraryCacheKeyResponseList(
      List<SelectorAndCostItineraryMappingEntity> selectorAndCostItineraryEntities);
}
