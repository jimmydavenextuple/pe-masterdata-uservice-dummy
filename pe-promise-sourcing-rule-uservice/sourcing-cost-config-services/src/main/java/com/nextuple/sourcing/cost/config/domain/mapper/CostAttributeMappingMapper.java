...
public interface CostAttributeMappingMapper {
  CostAttributeMappingEntity toCostAttributeMappingEntity(
      CostAttributeMappingRequest costAttributeMappingRequest);

  CostAttributeMappingResponse toCostAttributeMappingResponse(
      CostAttributeMappingEntity costAttributeMappingEntity);

  void updateCostAttributeMappingEntity(
      CostAttributeMappingRequest costAttributeMappingRequest,
      @MappingTarget CostAttributeMappingEntity costAttributeMappingEntity);

  List<CostAttributeMappingCacheKeyDto> toCostAttributeMappingCacheKeyResponseList(
