...
public interface CostValueMapper {
  CostValueEntity toCostValueEntityFromCreateCostValueRequest(
      CreateCostValueRequest createCostValueRequest);

  CostValueEntity toCostValueEntityFromUpdateCostValueRequest(
      UpdateCostValueRequest createCostValueRequest);

  CostValueResponse toCostValueResponse(CostValueEntity costValueEntity);

  List<CostValueCacheKeyDto> toCostValueCacheKeyResponseList(
