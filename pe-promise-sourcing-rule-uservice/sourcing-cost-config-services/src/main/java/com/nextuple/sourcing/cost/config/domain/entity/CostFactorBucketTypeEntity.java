...
@Table(
    name = "cost_factor_bucket_type",
    indexes =
        @Index(
            name = "cost_factor_bucket_type_orgId_costFactor",
            columnList = "org_Id,cost_factor"))
public class CostFactorBucketTypeEntity extends CommonBaseEntity {
  @Id
