...
public interface OptimizationAndCostTypesMapper {
  OptimizationAndCostTypesMappingEntity toOptimizationAndCostTypesMappingEntity(
      CreateOptimizationAndCostTypesMappingRequest createOptimizationAndCostTypesMappingRequest);

  OptimizationAndCostTypesMappingResponse toOptimizationAndCostTypesMappingResponse(
      OptimizationAndCostTypesMappingEntity selectorAndCostItineraryMappingEntity);

  void updateOptimizationAndCostTypesMappingRequestToEntity(
      UpdateOptimizationAndCostTypesMappingRequest updateOptimizationAndCostTypesMappingRequest,
      @MappingTarget OptimizationAndCostTypesMappingEntity optimizationAndCostTypesMappingEntity);
}
