...
@Table(
    name = "cost_factor",
    indexes = @Index(name = "cost_factor_id_orgId", columnList = "id,org_id"))
public class CostFactorEntity extends CommonBaseEntity {
  @Id
  ...
  @Column(name = "is_rate_card_look_up_required")
