...
@Table(
    ...
    indexes = @Index(name = "selector_and_cost_itinerary_id_orgId", columnList = "id,org_id"))
public class SelectorAndCostItineraryMappingEntity extends CommonBaseEntity {
  ...
  @Column(name = "selector_cf")
  private String selectorCf;

  @Column(name = "selector_cf_value")
