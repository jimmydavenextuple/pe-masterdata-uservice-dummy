...
@Inherited
@Operation(
    summary = "Get Selector and Cost Itinerary Mapping Cache Keys",
    description =
        "Retrieves the list of all the cache keys for the selector and cost itinerary mapping.")
@ApiResponse(
    responseCode = "200",
    description =
        "When all the cache keys for selector and cost itinerary mapping are retrieved successfully.",
    content =
        @Content(
            ...
            examples = {
              @ExampleObject(
                  summary =
                      "When all the cache keys for selector and cost itinerary mapping are retrieved successfully.",
                  name =
                      "A 200 success code indicates that all the cache keys for selector and cost itinerary mapping are retrieved successfully.",
                  value =
                      """
                                                      {
                                                                  "success": true,
                                                                  "requestId": "b9254695-dae8-4d4c-b495-3b552f08b04f#312",
                                                                  "timestamp": 1702021444546,
...
public @interface GetSelectorAndCostItineraryMappingCacheKeysDoc {}
