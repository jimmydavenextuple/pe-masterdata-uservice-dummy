...
@Inherited
@Operation(
    summary = "Create Cost Factor Contiguous Bucket",
    description = "Creates a Cost Factor Contiguous Bucket Type for a given organization ID.")
@ApiResponse(
    responseCode = "201",
    description = "When Cost Factor Contiguous Bucket Type is successfully created.",
    content =
        @Content(
            schema = @Schema(implementation = CostFactorContiguousBucketDto.class),
            examples = {
              @ExampleObject(
                  summary = "When Cost Factor Contiguous Bucket Type is successfully created.",
                  name =
                      "A 201 response indicates that the Cost Factor Contiguous Bucket Type is successfully created.",
                  value =
                      """
                                                {
                                                       "success": true,
                                                       "requestId": "638c1d95-d470-4d91-9da3-643ad741178c#11290",
                                                       "timestamp": 1702293001276,
              ...
              @ExampleObject(
                  ...
                  value =
                      """
                                                {
                                                        "success": false,
                                                        "requestId": "638c1d95-d470-4d91-9da3-643ad741178c#11294",
                                                        "timestamp": 1702293047357,
              ...
              @ExampleObject(
                  ...
                  value =
                      """
                                                {
                                                       "success": false,
                                                       "requestId": "638c1d95-d470-4d91-9da3-643ad741178c#11292",
                                                       "timestamp": 1702293020200,
...
public @interface CreateCostFactorContiguousBucketDoc {}
