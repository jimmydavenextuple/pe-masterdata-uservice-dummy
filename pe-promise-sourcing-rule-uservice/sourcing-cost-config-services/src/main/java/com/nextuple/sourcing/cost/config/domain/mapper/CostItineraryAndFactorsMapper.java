...
public interface CostItineraryAndFactorsMapper {
  CostItineraryAndFactorsEntity toCostItineraryAndFactorsEntity(
      CostItineraryAndFactorsRequest costItineraryAndFactorsRequest);

  CostItineraryAndFactorsEntity toCostItineraryAndFactorsEntityFromDto(
      CostItineraryAndFactorsDto costItineraryAndFactorsDto);

  CostItineraryAndFactorsDto toCostItineraryAndFactorsDto(
      CostItineraryAndFactorsEntity costItineraryAndFactorsEntity);

  List<CostItineraryAndFactorsCacheKeyDto> toCostItineraryAndFactorsCacheKeyResponseList(
