...
@Inherited
@Operation(
    summary = "Create Cost Attribute Mapping",
    description = "Creates a Cost Attribute Mapping for a given organization ID.")
@ApiResponse(
    responseCode = "201",
    description = "When Cost Attribute Mapping is successfully created.",
    content =
        @Content(
            schema = @Schema(implementation = CostAttributeMappingResponse.class),
            examples = {
              @ExampleObject(
                  summary = "When Cost Attribute Mapping is successfully created.",
                  name =
                      "A 201 OK response indicates that the Cost Attribute Mapping is successfully created.",
                  value =
                      """
                              {
                                      "success": true,
                                      "requestId": "02d5406f-5269-40a6-abf7-d9b5d1c1701d#4706",
                                      "timestamp": 1701948970839,
                                      "message": "Cost Attribute Mapping created successfully!",
                                      "payload": {
                                          "id": 24,
                                          "orgId": "NEXTUPLE_GR",
                                          "canonicalName": "itemHeight",
                                          "displayName": "Item Height",
                                          "attributeName": "itemHeight"
                                      }
                                  }
                         """)
            }))
...
public @interface CreateCostAttributeMappingDoc {}
