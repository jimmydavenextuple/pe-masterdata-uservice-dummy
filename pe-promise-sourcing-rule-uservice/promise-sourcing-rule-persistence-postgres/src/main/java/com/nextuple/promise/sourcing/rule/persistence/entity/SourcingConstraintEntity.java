...
@SuperBuilder
@Data
@Table(name = "sourcing_constraint")
public class SourcingConstraintEntity extends CommonBaseEntity {
  ...
  @Column(name = "sourcing_constraint")
  @Enumerated(EnumType.STRING)
  private SourcingConstraintEnum sourcingConstraint;

  @Column(name = "sourcing_constraint_value")
