...
@Repository
public interface AttributeValuesRepository
    extends CommonJpaRepository<AttributeValuesEntity, AttributeValuesKey> {
  List<AttributeValuesEntity> findByNameId(Long id);

  void deleteByNameIdAndValue(Long attributeId, String value);

  List<AttributeValuesEntity> findByNameIdIn(List<Long> nameIds);
}
