...
@Repository
public interface SourcingConstraintRepository
    extends CommonJpaRepository<SourcingConstraintEntity, SourcingConstraintKey> {
  Optional<SourcingConstraintEntity> findByIdAndOrgId(long id, String orgId);

  List<SourcingConstraintEntity> findByOrgIdAndGroupId(String orgId, String groupId);

  List<SourcingConstraintEntity> findByOrgIdAndGroupIdAndSourcingConstraint(
