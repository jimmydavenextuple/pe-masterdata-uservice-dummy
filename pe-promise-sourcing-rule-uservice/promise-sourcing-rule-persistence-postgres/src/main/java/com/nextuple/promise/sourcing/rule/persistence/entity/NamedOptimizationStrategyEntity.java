...
@SuperBuilder
@Data
@Table(name = "named_optimization_strategy")
public class NamedOptimizationStrategyEntity extends CommonBaseEntity {
  ...
  @Column(name = "optimization_strategy_name")
  private String optimizationStrategyName;

  @Column(name = "optimization_strategy_details")
