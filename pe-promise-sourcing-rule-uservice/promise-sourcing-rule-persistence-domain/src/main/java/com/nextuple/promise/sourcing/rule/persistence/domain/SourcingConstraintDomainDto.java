...
@NoArgsConstructor
@AllArgsConstructor
public class SourcingConstraintDomainDto extends DomainBaseEntity implements Serializable {

  private static final long serialVersionUID = 4375061907183444367L;
  private Long id;
