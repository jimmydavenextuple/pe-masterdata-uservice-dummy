...
public interface SourcingRulesConfigurationMapper {

  SourcingRulesConfigurationDomainDto toRulesConfigurationEntity(
      RulesConfigurationRequest rulesConfigurationRequest);

  SourcingRuleDetails toSourcingRuleDetails(
      SourcingRulesConfigurationDomainDto sourcingRulesConfigurationDomainDto);

  void updateSourcingRule(
      SourcingRuleUpdationRequest sourcingRuleUpdationRequest,
      @MappingTarget SourcingRulesConfigurationDomainDto sourcingRulesConfigurationDomainDto);

  List<SourcingRuleDetails> toSourcingRuleDetailsList(
      List<SourcingRulesConfigurationDomainDto> sourcingRulesConfigurationEntityList);

  SourcingRulesInfo toSourcingRuleInfo(
      SourcingRulesConfigurationDomainDto sourcingRulesConfigurationDomainDto);
}
