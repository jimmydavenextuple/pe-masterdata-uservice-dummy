...
@Operation(
    ...
    description = "Deletes the value of the sourcing attribute defined for the orgId.")
@ApiResponse(
    responseCode = "200",
    description =
        "A 200 success code indicates that a values of the attribute is deleted successfully.",
    content =
        @Content(
            examples = {
              @ExampleObject(
                  value =
                      """
                                                {
                                                    "success": true,
                                                    "requestId": "11af6b22-dfd2-4069-9826-55c3473802ac#245",
                                                    "timestamp": 1704361591103,
...
public @interface DeleteAttributeValueDoc {}
