...
@Inherited
@Operation(
    summary = "Update Named Optimization Strategy",
    description = "Updates the named optimization strategy with the given details.")
@ApiResponse(
    responseCode = "200",
    description =
        "A 200 success code indicates that the optimization strategy is successfully updated.")
@ApiResponse(
    responseCode = "400",
    description =
        "A 400 error code indicates that the request to update optimization strategy is invalid."
            + "<ul>"
            + "<li><b>Error code: 6001</b>:Optimization strategy is not found for given organization ID and group ID.</li>"
...
public @interface UpdateOptimizationStrategyDoc {}
