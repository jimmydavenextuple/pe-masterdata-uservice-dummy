...
public interface SourcingConstraintMapper {

  SourcingConstraintDomainDto toSourcingConstraintEntity(
      SourcingConstraintRequest sourcingConstraintRequest);

  SourcingConstraintDetailsResponse toSourcingConstraintDetailsResponse(
      SourcingConstraintDomainDto sourcingConstraintDomainDto);

  void updateSourcingConstraint(
      SourcingConstraintUpdationRequest updateRequest,
      @MappingTarget SourcingConstraintDomainDto sourcingConstraintDomainDto);
}
