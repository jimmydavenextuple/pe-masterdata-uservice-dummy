...
public interface SourcingAttributesDefinitionMapper {

  SourcingAttributesDefinitionDomainDto toSourcingRuleAttributesDefinitionEntity(
      SourcingAttributesDefinitionRequest sourcingRuleAttributesDefinitionRequest);

  SourcingAttributesDefinitionResponse toSourcingRuleAttributesDefinitionResponse(
      SourcingAttributesDefinitionDomainDto sourcingAttributesDefinitionDomainDto);

  void updateSourcingAttributesDefinitionEntity(
      SourcingAttributesDefinitionUpdationRequest sourcingRuleAttributesDefinitionUpdationRequest,
      @MappingTarget SourcingAttributesDefinitionDomainDto sourcingAttributesDefinitionDomainDto);
}
