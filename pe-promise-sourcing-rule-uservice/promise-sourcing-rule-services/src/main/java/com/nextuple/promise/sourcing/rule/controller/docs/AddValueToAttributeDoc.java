...
@Operation(
    ...
    description = "Adds a value to the sourcing attribute defined for the orgId.")
@ApiResponse(
    responseCode = "200",
    description =
        "A 200 success code indicates that a value to the attribute is added successfully.")
@ApiResponse(
    responseCode = "404",
    ...
    content =
        @Content(
            ...
            examples = {
              @ExampleObject(
                  summary = "When a given sourcing attribute is not found",
...
public @interface AddValueToAttributeDoc {}
