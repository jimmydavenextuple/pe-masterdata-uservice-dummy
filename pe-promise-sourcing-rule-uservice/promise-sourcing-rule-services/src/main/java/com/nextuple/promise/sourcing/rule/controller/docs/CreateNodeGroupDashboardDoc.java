...
@Operation(
    ...
    description = "Creates node group with the given details.")
@ApiResponse(
    responseCode = "200",
...
@ApiResponse(
    ...
    description =
        "A 400 error code indicates that the request to create a node group is invalid."
            ...
            + "<li><b>Error code: 6001</b>: The node group format is incorrect.</li>"
    ...
    content =
        @Content(
            ...
            examples = {
              @ExampleObject(
                  summary =
                      "When combination of organization ID and node group name is not unique.",
                  name =
                      "A 400 error code indicates that the combination of orgId and nodeGroupName is not unique.",
                  value =
                      """
                                                {
                                                    "success": false,
                                                ...
                                                """),
              @ExampleObject(
                  summary = "When the node group format is incorrect.",
                  name =
                      "A 400 error code indicates that the format of the node group is not correct.",
                  value =
                      """
                                                {
                                                    "success": false,
                                                ...
                                                """),
              @ExampleObject(
                  summary = "When the node ID is invalid.",
                  name =
                      "A 400 error code indicates that the nodes associating to node group is not valid.",
                  value =
                      """
                                                {
                                                    "success": false,
...
public @interface CreateNodeGroupDashboardDoc {}
