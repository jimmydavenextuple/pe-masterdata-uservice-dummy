...
@Inherited
@Operation(summary = "Update Node Group", description = "Updates the node group details.")
@ApiResponse(
    responseCode = "200",
    description =
...
@ApiResponse(
    responseCode = "400",
    description =
        "A 400 error code indicates that request to update the node group detail is invalid."
            + "<ul>"
...
@ApiResponse(
    responseCode = "404",
    description =
        "A 404 status code indicates that the node group for given id was not found."
...
public @interface UpdateNodeGroupDoc {}
