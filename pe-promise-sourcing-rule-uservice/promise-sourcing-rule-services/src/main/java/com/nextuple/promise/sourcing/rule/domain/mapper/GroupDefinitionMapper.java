...
public interface GroupDefinitionMapper {

  GroupDefinitionDomainDto toGroupDefinitionEntity(GroupDefinitionRequest groupDefinitionRequest);

  GroupDefinitionResponse toGroupDefinitionResponse(GroupDefinitionDomainDto groupDefinitionEntity);
}
