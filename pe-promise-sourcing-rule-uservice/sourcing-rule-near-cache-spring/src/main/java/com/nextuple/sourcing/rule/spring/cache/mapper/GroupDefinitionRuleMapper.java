...
@Component
public class GroupDefinitionRuleMapper
  ...
  @Override
  public GroupDefinitionRuleCacheKey requestToCacheKey(String request) {
    return null;
  }

  @Override
  public String cacheKeyToRequest(GroupDefinitionRuleCacheKey cacheKey) {
    return null;
  }

  @Override
  public GroupDefinitionRuleCacheValue responseToCacheValue(
      BaseResponse<GroupDefinitionResponse> resp) {
    return GroupDefinitionRuleCacheValue.builder()
        .groupDefinitionResponse(resp.getPayload())
        .build();
  }

  @Override
  public BaseResponse<GroupDefinitionResponse> cacheValueToResponse(
      GroupDefinitionRuleCacheValue cacheValue) {
    return null;
  }
}
