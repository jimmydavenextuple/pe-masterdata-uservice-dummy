...
@Component
public class RulesConfigurationMapper
  ...
  @Override
  public RulesConfigurationKey requestToCacheKey(String request) {
    return null;
  }

  @Override
  public String cacheKeyToRequest(RulesConfigurationKey cacheKey) {
    return null;
  }

  @Override
  public RulesConfigurationValue responseToCacheValue(
      BaseResponse<RulesConfigurationResponse> resp) {
    return DATA_MAPPER.toRuleConfigurationValue(resp.getPayload());
  }

  @Override
  public BaseResponse<RulesConfigurationResponse> cacheValueToResponse(
      RulesConfigurationValue cacheValue) {
    return null;
  }
}
