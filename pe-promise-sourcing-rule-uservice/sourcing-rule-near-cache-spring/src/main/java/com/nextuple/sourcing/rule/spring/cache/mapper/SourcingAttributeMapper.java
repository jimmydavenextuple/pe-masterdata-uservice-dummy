...
@Component
public class SourcingAttributeMapper
  ...
  @Override
  public SourcingAttributeByIdKey requestToCacheKey(String request) {
    return null;
  }

  @Override
  public String cacheKeyToRequest(SourcingAttributeByIdKey cacheKey) {
    return null;
  }

  @Override
  public SourcingAttributeByIdValue responseToCacheValue(
      BaseResponse<SourcingAttributeResponse> resp) {
    return DATA_MAPPER.toSourcingAttributeByIdValue(resp.getPayload());
  }

  @Override
  public BaseResponse<SourcingAttributeResponse> cacheValueToResponse(
      SourcingAttributeByIdValue cacheValue) {
    return null;
  }
}
