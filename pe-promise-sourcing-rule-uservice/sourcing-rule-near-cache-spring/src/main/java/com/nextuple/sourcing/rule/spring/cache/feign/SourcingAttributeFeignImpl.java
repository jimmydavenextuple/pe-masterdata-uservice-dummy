...
public interface SourcingAttributeFeignImpl
    extends GenericFeignService<String, BaseResponse<SourcingAttributeResponse>> {

  @GetMapping("/get")
  BaseResponse<SourcingAttributeResponse> get(String request);

  @GetMapping("/sourcing-attribute/orgId/{orgId}/id/{id}")
  BaseResponse<SourcingAttributeResponse> getSourcingAttributeByOrgIdAndId(
