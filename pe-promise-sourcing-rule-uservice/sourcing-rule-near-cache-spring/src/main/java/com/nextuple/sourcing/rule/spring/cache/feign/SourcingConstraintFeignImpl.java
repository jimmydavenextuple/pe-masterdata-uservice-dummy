...
public interface SourcingConstraintFeignImpl
    extends GenericFeignService<String, BaseResponse<SourcingConstraintsResponse>> {

  @GetMapping("/sourcing-constraint/get")
  BaseResponse<SourcingConstraintsResponse> get(String request);
