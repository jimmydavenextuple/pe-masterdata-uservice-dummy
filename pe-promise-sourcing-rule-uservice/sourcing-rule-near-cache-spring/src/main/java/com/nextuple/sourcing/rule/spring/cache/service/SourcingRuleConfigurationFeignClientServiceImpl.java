...
public class SourcingRuleConfigurationFeignClientServiceImpl
  ...
  private final SourcingRuleConfigurationFeignImpl souringRuleConfigurationFeign;
  ...
  public SourcingRuleConfigurationFetchRulesValue get(SourcingRuleConfigurationFetchRulesKey key) {
    try {
      return nodeMapper.responseToCacheValue(
          souringRuleConfigurationFeign.fetchSourcingRules(key.getFetchSourcingRulesRequest()));
    } catch (RuntimeException ex) {
      return SourcingRuleConfigurationFetchRulesValue.builder().build();
    }
  }
}
