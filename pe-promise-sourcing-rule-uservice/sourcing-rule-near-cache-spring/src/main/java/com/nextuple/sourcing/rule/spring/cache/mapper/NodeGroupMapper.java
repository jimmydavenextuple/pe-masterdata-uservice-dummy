...
@Component
public class NodeGroupMapper
    implements GenericMapper<
        NodeGroupCacheKey, NodeGroupCacheValue, String, BaseResponse<List<NodePriorityResponse>>> {

  @Override
  public NodeGroupCacheKey requestToCacheKey(String request) {
    return null;
  }

  @Override
  public String cacheKeyToRequest(NodeGroupCacheKey cacheKey) {
    return null;
  }

  @Override
  public NodeGroupCacheValue responseToCacheValue(
      BaseResponse<List<NodePriorityResponse>> response) {
    return NodeGroupCacheValue.builder().nodePriorityResponseList((response.getPayload())).build();
  }

  @Override
  public BaseResponse<List<NodePriorityResponse>> cacheValueToResponse(
      NodeGroupCacheValue cacheValue) {
    return null;
  }
}
