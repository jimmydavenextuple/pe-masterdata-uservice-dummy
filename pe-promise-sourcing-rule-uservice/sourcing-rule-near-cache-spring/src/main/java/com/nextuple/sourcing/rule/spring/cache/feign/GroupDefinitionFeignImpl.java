...
public interface GroupDefinitionFeignImpl
    extends GenericFeignService<String, BaseResponse<GroupDefinitionListResponse>> {
  @GetMapping("/group-definition/get")
  BaseResponse<GroupDefinitionListResponse> get(String request);
  ...
  BaseResponse<GroupDefinitionListResponse>
      getGroupDefinitionListByOrgIdAndSourcingAttributesDefinitionId(
          ...
          @PathVariable @NotNull Long sourcingAttributesDefinitionId);
}
