...
public interface SourcingRuleConfigurationFeignImpl
    extends GenericFeignService<String, BaseResponse<FetchSourcingRulesResponse>> {

  @GetMapping("/get")
  BaseResponse<FetchSourcingRulesResponse> get(String request);

  @PostMapping("/sourcing-rules-configuration/fetch-rules")
  BaseResponse<FetchSourcingRulesResponse> fetchSourcingRules(
      @RequestBody FetchSourcingRulesRequest fetchSourcingRulesRequest);
}
