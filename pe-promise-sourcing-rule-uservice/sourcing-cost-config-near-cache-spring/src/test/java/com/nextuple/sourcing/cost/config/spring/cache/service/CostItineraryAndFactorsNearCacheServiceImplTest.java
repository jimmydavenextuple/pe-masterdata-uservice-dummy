...
class CostItineraryAndFactorsNearCacheServiceImplTest {

  @InjectMocks
  private CostItineraryAndFactorsNearCacheServiceImpl costItineraryAndFactorsNearCacheService;
  ...
  void getTestForValidData() {
    ...
    // First Invocation
    CacheValue cacheValue1 = costItineraryAndFactorsNearCacheService.get(cacheKey);
  ...
  void getTestForInValidData() {
    ...
    assertNull(costItineraryAndFactorsNearCacheService.get(cacheKey));
    verify(feignCacheService, times(1)).get(cacheKey);
  }
  ...
  void deleteTest() {
    CostItineraryAndFactorsCacheKey cacheKey = testUtil.getCostItineraryAndFactorsCacheKey();
    costItineraryAndFactorsNearCacheService.delete(cacheKey);
    CacheValue cacheValue = costItineraryAndFactorsNearCacheService.get(cacheKey);
  ...
  void deleteAllTest() {
    CostItineraryAndFactorsCacheKey cacheKey = testUtil.getCostItineraryAndFactorsCacheKey();
    costItineraryAndFactorsNearCacheService.deleteAll();
    CacheValue cacheValue = costItineraryAndFactorsNearCacheService.get(cacheKey);
    assertNull(cacheValue);
  }
  ...
  void selfRegister() {
    ...
    costItineraryAndFactorsNearCacheService.selfRegister();
  ...
  void getEntityName() {
    assertEquals(
        ...
        costItineraryAndFactorsNearCacheService.getEntityName());
  }
}
