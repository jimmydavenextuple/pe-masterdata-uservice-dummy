...
class PreferenceSelectorNearCacheServiceImplTest {

  @InjectMocks private PreferenceSelectorNearCacheServiceImpl preferenceSelectorNearCacheService;

  @InjectMocks private TestUtil testUtil;

  @Mock
  private GenericFeignCacheService<PreferenceSelectorCacheKey, PreferenceSelectorCacheValue>
      feignCacheService;
  ...
  void getTestForValidData() {
    ...
    // First Invocation
    CacheValue cacheValue1 = preferenceSelectorNearCacheService.get(cacheKey);
  ...
  void getTestForInValidData() {
    ...
    assertNull(preferenceSelectorNearCacheService.get(cacheKey));
    verify(feignCacheService, times(1)).get(cacheKey);
  }
  ...
  void deleteTest() {
    PreferenceSelectorCacheKey cacheKey = testUtil.getPreferenceSelectorCacheKey();
    preferenceSelectorNearCacheService.delete(cacheKey);
    CacheValue cacheValue = preferenceSelectorNearCacheService.get(cacheKey);
  ...
  void deleteAllTest() {
    PreferenceSelectorCacheKey cacheKey = testUtil.getPreferenceSelectorCacheKey();
    preferenceSelectorNearCacheService.deleteAll();
    CacheValue cacheValue = preferenceSelectorNearCacheService.get(cacheKey);
    assertNull(cacheValue);
  }
  ...
  void selfRegister() {
    ...
    preferenceSelectorNearCacheService.selfRegister();
  ...
  void getEntityName() {
    assertEquals(
        ...
        preferenceSelectorNearCacheService.getEntityName());
  }
}
