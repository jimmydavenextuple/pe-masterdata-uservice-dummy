...
class CostAttributeMappingNearCacheServiceImplTest {

  @InjectMocks
  private CostAttributeMappingNearCacheServiceImpl costAttributeMappingNearCacheService;

  @InjectMocks private TestUtil testUtil;

  @Mock
  private GenericFeignCacheService<CostAttributeMappingCacheKey, CostAttributeMappingCacheValue>
      feignCacheService;
  ...
  void getTestForValidData() {
    ...
    // First Invocation
    CacheValue cacheValue1 = costAttributeMappingNearCacheService.get(cacheKey);
  ...
  void getTestForInValidData() {
    ...
    assertNull(costAttributeMappingNearCacheService.get(cacheKey));
    verify(feignCacheService, times(1)).get(cacheKey);
  }
  ...
  void deleteTest() {
    CostAttributeMappingCacheKey cacheKey = testUtil.getCostAttributeMappingCacheKey();
    costAttributeMappingNearCacheService.delete(cacheKey);
    CacheValue cacheValue = costAttributeMappingNearCacheService.get(cacheKey);
  ...
  void deleteAllTest() {
    CostAttributeMappingCacheKey cacheKey = testUtil.getCostAttributeMappingCacheKey();
    costAttributeMappingNearCacheService.deleteAll();
    CacheValue cacheValue = costAttributeMappingNearCacheService.get(cacheKey);
    assertNull(cacheValue);
  }
  ...
  void selfRegister() {
    ...
    costAttributeMappingNearCacheService.selfRegister();
  ...
  void getEntityName() {
    assertEquals(
        ...
        costAttributeMappingNearCacheService.getEntityName());
  }
}
