...
public interface DataMapper {
  ...
  CostFactorCacheValue toCostFactorCacheValue(CostFactorDto costFactorResponse);

  CostItineraryAndFactorsCacheValue toCostItineraryAndFactorsCacheValue(
      CostItineraryAndFactorsDto costItineraryAndFactorsDto);

  PreferenceSelectorCacheValue toPreferenceSelectorCacheValue(PreferenceSelectorDto payload);

  CostAttributeMappingCacheValue toCostAttributeMappingCacheValue(
      CostAttributeMappingResponse costAttributeMappingResponse);

  CostValueCacheValue toCostValueCacheValue(CostValueResponse costValueResponse);

  CostAttributeDetailsCacheValue toCostAttributeDetailsCacheValue(
      CostAttributeDto costAttributeDto);

  CostFactorBucketTypeCacheValue toCostFactorBucketTypeCacheValue(
      CostFactorBucketTypeDto costFactorBucketTypeDto);

  OptimizationAndCostTypesMappingValue toOptimizationAndCostTypesMappingValue(
