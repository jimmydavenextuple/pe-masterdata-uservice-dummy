...
@Component
public class TenantCostTypeMapper
  ...
  @Override
  public TenantCostTypeCacheKey requestToCacheKey(String request) {
    return null;
  }

  @Override
  public String cacheKeyToRequest(TenantCostTypeCacheKey cacheKey) {
    return null;
  }

  @Override
  public TenantCostTypeCacheValue responseToCacheValue(
      BaseResponse<List<TenantCostTypeResponse>> resp) {
    return TenantCostTypeCacheValue.builder().tenantCostTypeResponses(resp.getPayload()).build();
  }

  @Override
  public BaseResponse<List<TenantCostTypeResponse>> cacheValueToResponse(
      TenantCostTypeCacheValue cacheValue) {
    return null;
  }
}
