...
@Component
public class PreferenceSelectorMapper
  ...
  @Override
  public PreferenceSelectorCacheKey requestToCacheKey(String request) {
    return null;
  }

  @Override
  public String cacheKeyToRequest(PreferenceSelectorCacheKey cacheKey) {
    return null;
  }

  @Override
  public PreferenceSelectorCacheValue responseToCacheValue(
      BaseResponse<PreferenceSelectorDto> resp) {
    return DATA_MAPPER.toPreferenceSelectorCacheValue(resp.getPayload());
  }

  @Override
  public BaseResponse<PreferenceSelectorDto> cacheValueToResponse(
      PreferenceSelectorCacheValue cacheValue) {
    return null;
  }
}
