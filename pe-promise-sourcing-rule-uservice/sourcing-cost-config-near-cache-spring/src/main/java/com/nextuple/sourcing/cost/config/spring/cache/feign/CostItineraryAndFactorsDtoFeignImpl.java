...
public interface CostItineraryAndFactorsDtoFeignImpl
    extends GenericFeignService<String, BaseResponse<CostItineraryAndFactorsDto>> {

  @GetMapping("/cost-config/cost-itinerary-factors-mapping/{orgId}")
  BaseResponse<CostItineraryAndFactorsDto> get(@PathVariable String orgId);

  @GetMapping(
      "/cost-config/cost-itinerary-factors-mapping/{orgId}/{costItinerary}/{itineraryStatus}/{isActive}")
  BaseResponse<CostItineraryAndFactorsDto>
      getCostItineraryAndFactorsByOrgIdCostItineraryItineraryStatusAndIsActive(
          ...
          @NotNull @PathVariable ItineraryStatusEnum itineraryStatus,
          @NotNull @PathVariable Boolean isActive);
}
