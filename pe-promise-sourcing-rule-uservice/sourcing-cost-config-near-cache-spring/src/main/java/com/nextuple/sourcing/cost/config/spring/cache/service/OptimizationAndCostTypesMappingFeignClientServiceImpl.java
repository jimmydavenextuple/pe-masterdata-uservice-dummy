...
@Service
@AllArgsConstructor
public class OptimizationAndCostTypesMappingFeignClientServiceImpl
  ...
  private final OptimizationAndCostTypesMappingFeign optimizationAndCostTypesMappingFeign;

  private final OptimizationAndCostTypesMapper optimizationAndCostTypesMapper;

  @Override
  public OptimizationAndCostTypesMappingValue get(OptimizationAndCostTypesMappingKey key) {
    try {
      return optimizationAndCostTypesMapper.responseToCacheValue(
          optimizationAndCostTypesMappingFeign
              .fetchOptimizationAndCostTypesMappingByOrgIdAndStrategy(
                  key.getOrgId(), key.getOptimizationStrategy()));
    } catch (RuntimeException ex) {
      return OptimizationAndCostTypesMappingValue.builder().build();
    }
  }
}
