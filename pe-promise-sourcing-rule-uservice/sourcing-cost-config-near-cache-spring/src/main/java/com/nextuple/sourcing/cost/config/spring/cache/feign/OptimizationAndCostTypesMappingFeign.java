...
public interface OptimizationAndCostTypesMappingFeign
    extends GenericFeignService<String, BaseResponse<OptimizationAndCostTypesMappingResponse>> {

  @GetMapping("/get")
  BaseResponse<OptimizationAndCostTypesMappingResponse> get(String request);

  @GetMapping(
      "/cost-config/optimization-cost-types-mapping/{orgId}/optimizationStrategy/{optimizationStrategy}")
  BaseResponse<OptimizationAndCostTypesMappingResponse>
      fetchOptimizationAndCostTypesMappingByOrgIdAndStrategy(
          @NotBlank @PathVariable String orgId,
          @NotBlank @PathVariable String optimizationStrategy);
}
