...
@Component
public class CostFactorBucketTypeMapper
  ...
  @Override
  public CostFactorBucketTypeCacheKey requestToCacheKey(String request) {
    return null;
  }

  @Override
  public String cacheKeyToRequest(CostFactorBucketTypeCacheKey cacheKey) {
    return null;
  }

  @Override
  public CostFactorBucketTypeCacheValue responseToCacheValue(
      BaseResponse<CostFactorBucketTypeDto> resp) {
    return DATA_MAPPER.toCostFactorBucketTypeCacheValue(resp.getPayload());
  }

  @Override
  public BaseResponse<CostFactorBucketTypeDto> cacheValueToResponse(
      CostFactorBucketTypeCacheValue cacheValue) {
    return null;
  }
}
