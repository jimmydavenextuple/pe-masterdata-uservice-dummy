...
@Builder
@NoArgsConstructor
public class NodePriorityInfoV1 implements Serializable {
  private static final long serialVersionUID = 2347887507605655996L;

  @Schema(description = "Unique identifier for the node", example = "DC1")
  private String nodeId;

  @Schema(description = "Sequence of the given node within a node group.")
