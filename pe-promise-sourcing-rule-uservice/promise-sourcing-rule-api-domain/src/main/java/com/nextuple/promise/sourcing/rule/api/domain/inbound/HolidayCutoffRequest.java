...
@AllArgsConstructor
@NoArgsConstructor
public class HolidayCutoffRequest extends AdditionalAttributes implements Serializable {
  ...
  @NotBlank(message = "holidayCutoffDescription can't be empty")
  ...
  @Schema(description = "Colon separated attribute values.", example = "EXPRESS:R1:Store")
  ...
  @NotNull(message = "holidayCutoffDate can't be null")
  @Schema(
  ...
  @NotNull(message = "holidayDeliveryDate can't be null")
  @Schema(
