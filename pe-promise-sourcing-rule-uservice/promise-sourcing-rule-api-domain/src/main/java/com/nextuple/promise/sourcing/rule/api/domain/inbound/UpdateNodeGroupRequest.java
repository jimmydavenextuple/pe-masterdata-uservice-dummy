...
@AllArgsConstructor
@NoArgsConstructor
public class UpdateNodeGroupRequest implements Serializable {
  private static final long serialVersionUID = -7989836858961874207L;

  @Schema(description = "Unique name for node group", example = "NG1")
  @NotBlank(message = "Node Group name cannot be blank")
  private String nodeGroupName;

  @Schema(description = "Short description of the node group")
