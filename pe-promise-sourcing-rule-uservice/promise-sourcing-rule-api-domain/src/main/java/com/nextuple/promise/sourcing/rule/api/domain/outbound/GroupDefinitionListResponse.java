...
@AllArgsConstructor
@NoArgsConstructor
public class GroupDefinitionListResponse implements Serializable {
  ...
  @Schema(
      description =
          "Info about groups associated with the given organization ID and sourcing attributes definition ID.")
  private List<GroupDefinitionInfo> groupDefinitionInfoList;
}
