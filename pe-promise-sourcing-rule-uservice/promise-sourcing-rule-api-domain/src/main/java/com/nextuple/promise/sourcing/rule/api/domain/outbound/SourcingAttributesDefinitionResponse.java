...
@AllArgsConstructor
@NoArgsConstructor
public class SourcingAttributesDefinitionResponse extends AdditionalAttributes implements Serializable {

  private static final long serialVersionUID = 7466518627729401530L;

  @Schema(description = "Unique identifier for sourcing rule attributes definition.")
  private Long id;
  ...
  @Schema(
      description = "Unique name for the sourcing rule attributes definition.",
      example = "def1")
  private String name;
  ...
  @Schema(
      ...
      allowableValues = {"SOURCING_RULE", "OPTIMIZATION"})
  private SourcingAttributesDefinitionScopeEnum scope;

  @Schema(
      description = "The module for which the attributes are defined.",
      example = "SOURCING/PROMISING/BOTH")
