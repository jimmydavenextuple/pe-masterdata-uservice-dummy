...
@AllArgsConstructor
@NoArgsConstructor
public class FetchRuleConfigurationRequest implements Serializable {

  private static final long serialVersionUID = 6855307825248550991L;
  ...
  @NotNull(message = "attributeValuesInfo can't be empty or null")
  private SourcingAttributeValuesInfo attributeValuesInfo;

  @NotNull(message = "moduleName can't be empty or null")
  @Schema(
      description = "Module name for given rule configuration",
      allowableValues = {"PROCESSING_TIME"})
  private RulesConfigurationModuleNameEnum moduleName;

  @NotNull(message = "scope can't be empty or null")
  @Schema(
      description = "Scope for given rule configuration",
      allowableValues = {"SOURCING_RULE", "OPTIMIZATION", "HOLIDAY_CUTOFF", "ML_RULE"})
