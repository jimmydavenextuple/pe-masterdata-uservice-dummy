...
@AllArgsConstructor
@NoArgsConstructor
public class SourcingConstraintsResponse implements Serializable {

  private static final long serialVersionUID = -5342307374883933771L;
  ...
  @Schema(description = "List of constraints for a given organization ID and group ID.")
  private List<SourcingConstraintInfo> sourcingConstraintsInfo;
}
