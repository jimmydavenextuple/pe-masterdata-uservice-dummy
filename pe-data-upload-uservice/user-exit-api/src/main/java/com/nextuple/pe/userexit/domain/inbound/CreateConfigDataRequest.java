...
public class CreateConfigDataRequest extends AdditionalAttributes {
  ...
  @Schema(description = "Unique name for user the exit.", example = "GetItemDetails")
  private String userExitName;

  @NotBlank(message = "appName cannot be blank")
  @Schema(description = "Unique name for app", example = "PE")
  ...
  @Schema(description = "Unique name for service", example = "ItemService")
  ...
  @Schema(
      description = "Comma separated pairs of attributes required from input and their jsonPath",
      example =
