...
import static com.nextuple.jobs.framework.common.domain.enums.ApiStatusEnum.FAILURE;
import static com.nextuple.jobs.framework.common.domain.enums.ApiStatusEnum.SUCCESS;
...
import com.nextuple.jobs.consumers.exception.FeignClientMapperException;
...
public interface FeignClientMapper {
  ...
  default RecordStatusDto invokeAPI(RecordDto recordDto) {
    ...
    recordStatusDto.setJobType(JobTypeEnum.valueOf(recordDto.getJobType()));
  ...
  default Object getDtoFromRecord(RecordDto recordDto)
      throws FeignClientMapperException,
          IOException,
          TransitMapperException,
