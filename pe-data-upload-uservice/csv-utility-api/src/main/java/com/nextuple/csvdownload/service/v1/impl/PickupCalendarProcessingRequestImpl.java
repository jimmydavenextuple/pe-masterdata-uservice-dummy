...
import static com.nextuple.dataupload.common.constants.CommonDataUploadErrorConstants.PICKUP_CALENDAR_DATA_UPLOAD_INVALID_FILE_HEADERS;
import static com.nextuple.dataupload.common.constants.CommonDataUploadErrorConstants.PICKUP_CALENDAR_DATA_UPLOAD_INVALID_FILE_TYPE;
...
public class PickupCalendarProcessingRequestImpl extends AbstractProcessingRequest {
  ...
  public PickupCalendarProcessingRequestImpl(
  ...
  public void addErrorLine(CSVWriter writer, List<RecordStatusDto> recordStatusDtos)
      throws IOException {
    recordStatusDtos.forEach(dto -> constructPickupCalendarError(writer, dto));
    writer.flush();
  }

  private void constructPickupCalendarError(CSVWriter writer, RecordStatusDto recordStatusDto) {
    var gson = new Gson();
    var requestBody = gson.fromJson(recordStatusDto.getRequestBody(), PickUpCalendarUpload.class);
