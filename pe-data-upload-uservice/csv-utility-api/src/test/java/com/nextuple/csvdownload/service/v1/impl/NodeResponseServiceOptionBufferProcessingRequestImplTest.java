...
class NodeResponseServiceOptionBufferProcessingRequestImplTest {
  @InjectMocks
  ...
  public void init() {
    ...
    ReflectionTestUtils.setField(
        nodeServiceOptionBufferProcessingRequest, "recordsPerPage", TestUtil.RECORDS_PER_PAGE);
    ReflectionTestUtils.setField(
        nodeServiceOptionBufferProcessingRequest, "maxNoOfPages", TestUtil.MAX_NO_OF_PAGES);
  }
