...
class CarrierResponseServiceProcessingRequestImplTest {
  ...
  public void init() {
    ...
    ReflectionTestUtils.setField(
        carrierServiceProcessingRequest, "recordsPerPage", TestUtil.RECORDS_PER_PAGE);
    ReflectionTestUtils.setField(
        carrierServiceProcessingRequest, "maxNoOfPages", TestUtil.MAX_NO_OF_PAGES);
  }
