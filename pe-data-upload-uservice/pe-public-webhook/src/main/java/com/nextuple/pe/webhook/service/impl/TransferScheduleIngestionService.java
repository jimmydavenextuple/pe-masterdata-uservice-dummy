...
public class TransferScheduleIngestionService implements FeedIngestionService<MasterDataIngestionDto<TransferScheduleDto>>{
    ...
    @Override
    public void publish(String orgId, FeedRequest<MasterDataIngestionDto<TransferScheduleDto>> transferScheduleFeed) {
                ...
                .forEach(
                        transferScheduleDto -> {
                            ...
                            kafkaProducer.publishFeedToKafka(
                                    ...
                                    batchRequest, transferScheduleDto.getPayload().getRule(), transferScheduleFeedTopic);
                        });
    }
}
