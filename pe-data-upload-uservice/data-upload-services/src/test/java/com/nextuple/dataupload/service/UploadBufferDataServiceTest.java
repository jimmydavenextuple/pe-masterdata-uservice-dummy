...
import static com.nextuple.dataupload.helper.UploadBufferDataConstants.NODE_SERVICE_OPTION_BUFFER_DATA_UPLOAD_FAILED;
...
class UploadBufferDataServiceTest {
  ...
  public void setUp() {
    ...
    ReflectionTestUtils.setField(uploadBufferService, "nodeCarrierFeign", nodeCarrierFeign);
  }
  ...
  void UploadBufferDataSuccessTest() throws CommonServiceException, IOException {
    ...
    when(nodeCarrierFeign.createBuffer(any())).thenReturn(baseResponse);
