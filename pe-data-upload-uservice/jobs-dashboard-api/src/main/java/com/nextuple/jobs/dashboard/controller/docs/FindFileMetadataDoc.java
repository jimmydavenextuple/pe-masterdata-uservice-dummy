...
@Operation(
    ...
    description = "Retrieves the file metadata for the file with the given ID.")
@ApiResponse(
    responseCode = "200",
    description =
        "A 200 success code indicates that the file metadata for a given ID is fetched successfully.")
@ApiResponse(
    responseCode = "400",
    description = "A 400 error code indicates that file metadata for the given ID was not found. ",
    content =
        @Content(
...
public @interface FindFileMetadataDoc {}
