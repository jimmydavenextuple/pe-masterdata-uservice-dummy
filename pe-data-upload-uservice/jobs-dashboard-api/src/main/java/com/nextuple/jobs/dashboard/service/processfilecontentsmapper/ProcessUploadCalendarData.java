    ...
    while (iterator.hasNext()) {
      ...
      var calendarDataUpload =
          CalendarDataUpload.builder()
              ...
              .isMondayWorking(csvRecord.get(IS_MONDAY_WORKING))
              .isTuesdayWorking(csvRecord.get(IS_TUESDAY_WORKING))
              .isWednesdayWorking(csvRecord.get(IS_WEDNESDAY_WORKING))
              .isThursdayWorking(csvRecord.get(IS_THURSDAY_WORKING))
              .isFridayWorking(csvRecord.get(IS_FRIDAY_WORKING))
              .isSaturdayWorking(csvRecord.get(IS_SATURDAY_WORKING))
              .isSundayWorking(csvRecord.get(IS_SUNDAY_WORKING))
              .exceptionDays(csvRecord.get(EXCEPTION_DAYS))
              .build();
