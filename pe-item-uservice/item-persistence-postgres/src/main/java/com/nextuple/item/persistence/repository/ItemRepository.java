...
@Repository
public interface ItemRepository extends CommonJpaRepository<ItemEntity, ItemKey> {
  ...
  Page<ItemEntity> findByItemIdInAndOrgId(List<String> itemList, String orgId, Pageable pageable);
}
