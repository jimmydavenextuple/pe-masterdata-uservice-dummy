...
package com.nextuple.item.persistence.mapper;
...
public interface ItemBufferEntityMapper
    extends DomainToEntityMapper<
        ItemBufferDomainDto, ItemBufferDomainKey, ItemBufferEntity, ItemBufferKey> {}
