...
class ItemMasterConsumerJSONTest {
  @InjectMocks private ItemMasterConsumerJSON itemMasterConsumer;
  ...
  void onItemMasterEventConsumptionExceptionTest1() throws ItemDomainException {
    ...
    Assertions.assertThrows(ConstraintViolationException.class, this::consumeItemMasterEvent);
  }
  ...
  private void consumeItemMasterEvent() throws ItemDomainException {
    itemMasterConsumer.onItemMasterEventConsumption(testUtil.getItemMasterEvent(), null);
  }
