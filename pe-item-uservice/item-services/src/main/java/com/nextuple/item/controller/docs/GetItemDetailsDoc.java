...
@Inherited
@Operation(summary = "Get Item Details", description = ItemConstants.GET_ITEM_DESC)
@ApiResponse(responseCode = "200", description = ItemConstants.GET_ITEM_SUCCESS)
@ApiResponse(
    responseCode = "400",
    description =
        "A 400 error code indicates that the request to retrieve item details is not valid.")
@ApiResponse(
    responseCode = "404",
    description =
        "A 404 error code indicates that there is an issue with the input."
            + "<ul>"
            + "<li><b>Error code: 6001</b>: Item is not found for the given details.</li>"
            + "</ul>",
    content =
        @Content(
...
public @interface GetItemDetailsDoc {}
