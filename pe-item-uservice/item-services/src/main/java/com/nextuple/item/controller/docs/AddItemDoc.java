...
@ApiResponse(
    ...
    content =
        @Content(
            ...
            examples = {
              @ExampleObject(
                  summary = ItemConstants.ADD_ITEM_SUCCESS,
                  name = ItemConstants.ADD_ITEM_DESC,
                  value =
                      """
                                {
                                                     "success": true,
...
@ApiResponse(
    ...
    description =
        "A 400 error code indicates that there is an issue with the input."
            ...
            + "<li><b>Error code: 2</b>: Item ID is not passed.</li>"
            + "<li><b>Error code: 2</b>: UOM is not passed.</li>"
            + "</ul>",
    content =
        @Content(
              ...
              @ExampleObject(
                  ...
                  value =
                      "{\n"
                          ...
                          + "}"),
              @ExampleObject(
                  summary = "ItemId is not passed.",
                  name =
                      "A 400 error code indicates that the itemId is not passed and it is a mandatory field.",
                  value =
                      "{\n"
                          + "    \"success\": false,\n"
                          + "    \"requestId\": \"571473d2-d27f-4f0b-903c-91149805876e\",\n"
                          ...
                          + "            \"orgId\": {\n"
                          + "                \"rejectedValue\": \"\",\n"
                          + "                \"errorMessage\": \"itemId can't be blank\"\n"
                          + "            }\n"
                          + "        }\n"
                          + "    }\n"
                          + "}"),
              @ExampleObject(
                  summary = "Uom is not passed.",
                  name =
                      "A 400 error code indicates that the uom is not passed and it is a mandatory field.",
                  value =
                      "{\n"
                          + "    \"success\": false,\n"
                          + "    \"requestId\": \"571473d2-d27f-4f0b-903c-91149805876e\",\n"
                          ...
                          + "            \"orgId\": {\n"
                          + "                \"rejectedValue\": \"\",\n"
                          + "                \"errorMessage\": \"uom can't be blank\"\n"
                          + "            }\n"
                          + "        }\n"
                          + "    }\n"
                          + "}")
