...
@Inherited
@Operation(
    summary = "Get Item Substitutions",
    description = "Retrieve substitution relationships for a given primary item")
@ApiResponse(
    responseCode = "200",
    description = "Item substitutions retrieved successfully",
    content =
        @Content(
            array = @ArraySchema(schema = @Schema(implementation = ItemSubstitutionResponse.class)),
            examples = {
              @ExampleObject(
                  summary = "Retrieved list of item substitutions",
                  name = "Retrieve substitution relationships for a given primary item",
                  value =
                      """
                                {
                                    "success": true,
...
public @interface GetItemSubstitutionDoc {}
