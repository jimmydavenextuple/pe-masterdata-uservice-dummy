...
@NoArgsConstructor
@SuperBuilder
public class ItemBufferRequest extends AdditionalAttributes implements Serializable {

  private static final long serialVersionUID = -3860539115655506350L;
  ...
  @NotNull(message = "bufferHours can't be blank")
