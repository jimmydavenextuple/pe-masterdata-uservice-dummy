...
@Inherited
@Operation(summary = "Get Vendor Details", description = VendorConstants.GET_VENDOR_DESC)
@ApiResponse(responseCode = "200", description = VendorConstants.GET_VENDOR_DETAILS_SUCCESS)
@ApiResponse(
    responseCode = "400",
    description =
...
public @interface GetVendorDetailsDoc {}
