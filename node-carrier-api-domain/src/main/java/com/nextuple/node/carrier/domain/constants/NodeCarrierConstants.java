...
public class NodeCarrierConstants {
  ...
  public static final String UPDATE_BUFFER_DESC =
      "Updates the information such as buffer time or buffer hours for the stores. An enterprise can use this API to quickly update the buffer time across their stores. Stores can update the buffer time during Christmas when orders are higher, or during the holidays when the stores are not operational on certain days. This API can be used to update the Buffer Start Date and Buffer End Date to update the Buffer Hours.";

  public static final String ID = "Unique identifier of the node service option buffer.";
