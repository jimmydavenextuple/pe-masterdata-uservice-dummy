...
public class NodeConstants {
  ...
  public static final String CREATE_NODE_DESC =
      "Creates a node using different attributes such as the organization ID, address, and postal code. The following types of nodes can be created: Fulfillment Centre (FC), Micro-Fulfillment Centre (MFC), Store and Drop-Ship Vendor (DSV).";
  ...
  public static final String UPDATE_NODE_DESC =
      "Updates the node information such as organization ID, address, and postal code for the given node ID and organization ID.";
  ...
  public static final String POSTAL_CODE = "Postal code of the node.";
  public static final String POSTAL_CODE_EXAMPLE = "M1R 5A2";
  ...
  public static final String PROVINCE = "Province in which the node is located.";
  public static final String PROVINCE_EXAMPLE = "ON";
