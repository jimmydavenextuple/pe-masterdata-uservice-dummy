...
public interface TransitBufferConfigRequestPersistenceService
    extends DomainPersistenceService<
        TransitBufferConfigRequestDomainDto, TransitBufferConfigRequestDomainKey> {
  TransitBufferConfigRequestDomainDto saveTransitBufferConfigRequest(
      TransitBufferConfigRequestDomainDto transitBufferConfigRequestDomainDto)
      throws CommonServiceException;

  Optional<TransitBufferConfigRequestDomainDto> findById(Long id) throws CommonServiceException;

  List<TransitBufferConfigRequestDomainDto> findByOrgIdAndCarrierServiceId(
