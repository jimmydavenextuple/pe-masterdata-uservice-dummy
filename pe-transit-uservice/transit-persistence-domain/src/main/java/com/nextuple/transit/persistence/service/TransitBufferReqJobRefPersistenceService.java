...
public interface TransitBufferReqJobRefPersistenceService
    extends DomainPersistenceService<
        TransitBufferReqJobRefDomainDto, TransitBufferReqJobRefDomainKey> {

  TransitBufferReqJobRefDomainDto saveTransitBufferReqJobRefRepository(
      TransitBufferReqJobRefDomainDto transitBufferReqJobRefDomainDto)
      throws CommonServiceException;

  List<TransitBufferReqJobRefDomainDto> findByExtReferenceId(String extReferenceId)
      throws CommonServiceException;
}
