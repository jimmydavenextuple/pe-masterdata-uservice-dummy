...
@Inherited
@Operation(
    summary = "Create Transit Buffer",
    description =
        "Adds the transit buffer details for the given transit data if the details are not already present.")
@ApiResponse(
    responseCode = "200",
...
public @interface CreateTransitBufferDoc {}
