...
import static com.nextuple.dataupload.common.constants.CommonDataUploadErrorConstants.TRANSIT_BUFFER_DATA_UPLOAD_EMPTY_DATA_IN_THE_CSV;
import static com.nextuple.dataupload.common.constants.CommonDataUploadErrorConstants.TRANSIT_BUFFER_DATA_UPLOAD_INVALID_FILE_HEADERS;
import static com.nextuple.dataupload.common.constants.CommonDataUploadErrorConstants.TRANSIT_BUFFER_DATA_UPLOAD_INVALID_FILE_TYPE;
import static com.nextuple.dataupload.common.constants.DataUploadUtilityConstants.ACTION;
import static com.nextuple.dataupload.common.constants.DataUploadUtilityConstants.BUFFER_DAYS;
import static com.nextuple.dataupload.common.constants.DataUploadUtilityConstants.BUFFER_END_DATE;
import static com.nextuple.dataupload.common.constants.DataUploadUtilityConstants.BUFFER_START_DATE;
import static com.nextuple.dataupload.common.constants.DataUploadUtilityConstants.CREATED_BY;
import static com.nextuple.dataupload.common.constants.DataUploadUtilityConstants.CREATE_C;
...
import static com.nextuple.dataupload.common.constants.DataUploadUtilityConstants.UPDATE_U;
...
import com.nextuple.transit.domain.mapper.TransitBufferConfigRequestMapper;
...
public class TransitBufferConfigRequestService {
  ...
  private TransitBufferConfigResponse createTransitBufferDetails(
    ...
    DataUploadUtil.validateCSVHeaders(
        ...
        csvReader);
    List<String[]> csvFileContentsCopy = new ArrayList<>(csvFileContents);

    /** validating for empty source or destination geoZone value */
    DataUploadUtil.validateForEmptySourceOrDestinationGeozoneCSVData(
        csvFileContentsCopy, TRANSIT_BUFFER_DATA_UPLOAD_EMPTY_DATA_IN_THE_CSV, csvReader);
  ...
  private TransitBufferConfigResponse updateTransitBufferDetails(
    ...
    var existingTransitBufferConfigRequestDomainDto =
        getTransitBufferRequest(transitBufferConfigRequest.getTransitBufferRequestId());
    var fileMetaDataResponse =
        jobsDashboardClient
            .findFileMetadataById(existingTransitBufferConfigRequestDomainDto.getFileMetaDataId())
            .getPayload();
    ...
    var fileMetaDataResponseForNewFile =
        readCsvFileAndCreateNewFile(
            ...
            newTransitBufferConfigRequestEntity.getId());
    csvReader.close();
    existingTransitBufferConfigRequestDomainDto.setStatus(
        TransitBufferConfigRequestStatusEnum.INACTIVE);
    transitBufferConfigRequestPersistenceService.saveTransitBufferConfigRequest(
        existingTransitBufferConfigRequestDomainDto);
  ...
  private TransitBufferConfigRequestDomainDto createTransitBufferConfigEntity(
      TransitBufferConfigRequest transitBufferConfigRequest,
      FileMetaDataResponse fileMetaDataResponse)
      throws CommonServiceException {
    var transitBufferConfigDomainDto =
        INSTANCE.toTransitBufferConfigDomainDto(transitBufferConfigRequest);
    transitBufferConfigDomainDto.setFileMetaDataId(fileMetaDataResponse.getId());
    transitBufferConfigDomainDto.setStatus(TransitBufferConfigRequestStatusEnum.CREATED);
    if (!ObjectUtils.isEmpty(transitBufferConfigRequest.getTransitBufferRequestId())) {
      transitBufferConfigDomainDto.setParentRequestId(
          transitBufferConfigRequest.getTransitBufferRequestId());
    }
    return transitBufferConfigRequestPersistenceService.saveTransitBufferConfigRequest(
        transitBufferConfigDomainDto);
  }

  private void createTransitBufferRequestJobReference(
      JobResponse jobResponse,
      TransitBufferConfigRequestDomainDto savedTransitBufferConfigRequestEntity,
  ...
  private FileMetaDataResponse readCsvFileAndCreateNewFile(
    ...
    Path tempFile = Files.createTempFile(uuid.toString(), ".csv", attr);
  ...
  public TransitBufferConfigResponse updateTransitBufferRequestStatus(
    ...
    Optional<TransitBufferConfigRequestDomainDto> existingTransitBufferConfigRequestEntity =
        transitBufferConfigRequestPersistenceService.findById(id);
    ...
    return INSTANCE.toTransitBufferConfigResponse(
        transitBufferConfigRequestPersistenceService.saveTransitBufferConfigRequest(
            existingTransitBufferConfigRequestEntity.get()));
  }
  ...
  public List<TransitBufferConfigResponse> fetchTransitBufferRequests(
    ...
    try {
      ...
      List<TransitBufferConfigRequestDomainDto> transitBufferConfigRequestDomainDtos =
          transitBufferConfigRequestPersistenceService.findByOrgIdAndCarrierServiceId(
              orgId, carrierServiceId, filteredStatus);
      List<TransitBufferConfigResponse> transitBufferConfigResponses = new ArrayList<>();
      for (TransitBufferConfigRequestDomainDto transitBufferConfigRequestDomainDto :
          transitBufferConfigRequestDomainDtos) {
        createTransitBufferConfigResponse(
            transitBufferConfigResponses, transitBufferConfigRequestDomainDto);
      }
  ...
  public TransitBufferConfigRequestDomainDto getTransitBufferRequest(Long id)
      throws CommonServiceException {
    ...
    if (transitBufferConfigRequestEntity.isEmpty()) {
      ...
      errorMap.put(
          TRANSIT_BUFFER_CONFIG_REQUEST_ID, FieldError.builder().rejectedValue(id).build());
      throw new CommonServiceException(
          TRANSIT_BUFFER_CONFIG_REQUEST_EXCEPTION_MESSAGE,
          HttpStatus.BAD_REQUEST,
          0x1771,
          errorMap);
    }
