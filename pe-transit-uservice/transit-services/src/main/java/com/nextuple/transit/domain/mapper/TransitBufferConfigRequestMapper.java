...
public interface TransitBufferConfigRequestMapper {
  ...
  TransitBufferConfigRequestDomainDto toTransitBufferConfigDomainDto(
  ...
  TransitBufferConfigResponse toTransitBufferConfigResponse(
      TransitBufferConfigRequestDomainDto transitBufferConfigRequestDomainDto, String fileName);
}
