...
@Operation(
    ...
    description =
        "Updates the zone information for a given carrier service and geo zones. This API updates the information by passing the organization ID, source geo zone, destination geo zone, and carrier service ID attributes in the path parameters for the required zone.")
@ApiResponse(
    responseCode = "200",
    description =
        "A 200 success code indicates that the zone information for a given zone is updated successfully.",
    content =
        @Content(
            schema = @Schema(implementation = ZoneResponse.class),
            examples = {
              @ExampleObject(
                  summary = "When zone information for a given zone is updated successfully.",
                  name =
                      "A 200 success code indicates that the zone information for a given zone is updated successfully.",
                  value =
                      """
...
public @interface UpdateZoneDataDoc {}
