...
@Inherited
@Operation(
    summary = "Delete Transit Buffer",
    description = "Deletes the transit buffer details for a valid transit record.")
@ApiResponse(
    responseCode = "200",
    description =
        "A 200 success code indicates that the transit buffer details are deleted successfully.")
@ApiResponse(
    responseCode = "400",
    description =
...
public @interface DeleteTransitBufferDetailsDoc {}
