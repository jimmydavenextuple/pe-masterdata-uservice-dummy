...
@Inherited
@Operation(
    summary = "Delete transit buffer by Organization ID and Buffer ID",
    description = "Deletes transit buffer details for the given organization ID and buffer ID.")
@ApiResponse(
    responseCode = "200",
...
public @interface DeleteTransitBufferByOrgIdAndIdDoc {}
