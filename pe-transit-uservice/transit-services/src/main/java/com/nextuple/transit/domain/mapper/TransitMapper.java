...
public interface TransitMapper {
  ...
  TransitDomainDto toTransitDomainDtoFromRequest(
      TransitDataCreationRequest transitDataCreationRequest);

  TransitResponse toTransitResponse(TransitDomainDto transitDomainDto);

  TransitDomainDto updateTransitDomainDto(
      TransitDataUpdationRequest transitDataUpdationRequest,
      @MappingTarget TransitDomainDto updatedTransitDomainDto);

  List<TransitResponse> toTransitResponseList(List<TransitDomainDto> transitDomainDto);
