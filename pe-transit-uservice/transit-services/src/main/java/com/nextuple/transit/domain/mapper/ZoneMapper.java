...
public interface ZoneMapper {
  ...
  ZoneDomainDto convertToZoneEntity(ZoneRequest zoneRequest);

  ZoneResponse convertToZoneResponse(ZoneDomainDto zoneDomainDto);

  List<ZoneResponse> convertToZoneResponseList(List<ZoneDomainDto> zoneDomainDtoList);
}
