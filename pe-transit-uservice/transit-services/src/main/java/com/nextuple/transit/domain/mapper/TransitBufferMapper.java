...
public interface TransitBufferMapper {
  TransitBufferDomainDto toTransitBufferDomainDto(TransitBufferRequest transitBufferRequest);

  TransitBufferResponse toTransitBufferResponse(TransitBufferDomainDto transitBufferDomainDto);
