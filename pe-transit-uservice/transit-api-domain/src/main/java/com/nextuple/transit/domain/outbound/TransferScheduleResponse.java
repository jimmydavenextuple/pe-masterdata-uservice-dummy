...
@NoArgsConstructor
@Builder
public class TransferScheduleResponse implements Serializable {
  private static final long serialVersionUID = 5056485583045674868L;
  ...
  @Schema(
          description = "Rule associated with the transfer schedule",
          example = "DC:KITCHEN"
  )
  ...
  @Schema(
          description =  "Rule name associated with the transfer schedule",
          example = "KitchenRule"
  )
  @JsonInclude(Include.NON_NULL)
