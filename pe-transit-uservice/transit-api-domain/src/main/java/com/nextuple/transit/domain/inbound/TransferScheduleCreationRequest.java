...
@NoArgsConstructor
@Builder
public class TransferScheduleCreationRequest implements Serializable {
  ...
  @Schema(description = "Name of the rule assoicated with the transfer schedule.", example = "KitchenItemRule")
