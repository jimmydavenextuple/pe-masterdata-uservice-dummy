...
public class TransitBufferRequest extends AdditionalAttributes implements Serializable {
  ...
  @Schema(description = "User who created the transit data.", example = "user1@email.com")
  private String createdBy;

  @Schema(description = "User who updated the transit data.", example = "user2@email.com")
