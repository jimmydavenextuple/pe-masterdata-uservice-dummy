...
public interface TransitBatchMapper {
  TransitDataCreationRequest toTransitRequest(TransitFeedDto transitFeedDto);

  TransitDataUpdationRequest toTransitUpdateRequest(TransitFeedDto transitFeedDto);
}
