...
@AllArgsConstructor
@SuperBuilder
public class TransitBufferFeedDto extends CommonMasterDataFieldsDto implements Serializable {

  private static final long serialVersionUID = 8404228585823290376L;
  ...
  @Schema(description = BUFFER_DAYS, example = BUFFER_DAYS_EXAMPLE)
  private Double bufferDays;

  @Schema(description = BUFFER_END_DATE, example = BUFFER_END_DATE_EXAMPLE)
  private Date bufferEndDate;

  @Schema(description = BUFFER_START_DATE, example = BUFFER_START_DATE_EXAMPLE)
