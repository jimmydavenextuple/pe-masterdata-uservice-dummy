...
public class TransferScheduleConsumer extends MasterDataFeedConsumer<TransferScheduleDto>{
    ...
    public void consumeTransferScheduleFeed(
        ...
        try {
            ...
            log.error("Exception occurred while consuming transfer schedule feed : {}", transferScheduleFeed);
            throw e;
        }
    }
    @Override
    public void invokeFeedProcessingService(List<BatchRequest<TransferScheduleDto>> transferScheduleFeedList) {
