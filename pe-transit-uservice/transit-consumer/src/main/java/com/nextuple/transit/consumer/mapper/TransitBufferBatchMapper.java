...
public interface TransitBufferBatchMapper {
  TransitBufferRequest toTransitBufferRequest(TransitBufferFeedDto transitBufferFeedDto);

  TransitBufferDeletionRequest toTransitBufferDeleteRequest(
      TransitBufferFeedDto transitBufferFeedDto);
}
