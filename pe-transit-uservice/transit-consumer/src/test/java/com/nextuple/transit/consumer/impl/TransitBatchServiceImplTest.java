...
class TransitBatchServiceImplTest {

  @InjectMocks private TransitBatchServiceImpl transitBatchService;
  ...
  void init() {
    ...
    ReflectionTestUtils.setField(transitBatchService, "errorHandlingService", errorHandlingService);
    ReflectionTestUtils.setField(transitBatchService, "transitFeign", transitFeign);
  }
