...
public interface TransferScheduleEntityMapper
    extends DomainToEntityMapper<
        TransferScheduleDomainDto,
        TransferScheduleDomainKey,
        TransferScheduleEntity,
        TransferScheduleKey> {
  TransferScheduleResponse convertToTransferScheduleResponseFromEntity(
      TransferScheduleEntity transferScheduleEntity);
}
