...
@Repository
public interface ZoneRepository extends CommonJpaRepository<ZoneEntity, ZoneKey> {

  List<ZoneEntity> findByOrgIdAndDestinationGeozone(String orgId, String destinationGeozone);
}
