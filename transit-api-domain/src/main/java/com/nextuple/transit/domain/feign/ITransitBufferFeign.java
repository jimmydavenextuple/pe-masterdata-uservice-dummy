...
public interface ITransitBufferFeign<R, Q> {
  BaseResponse<R> createTransitBuffer(@Valid @RequestBody Q q);

  BaseResponse<R> updateTransitBuffer(@Valid @RequestBody Q q);

  BaseResponse<R> deleteTransitBufferDetails(@Valid @RequestBody Q q);
