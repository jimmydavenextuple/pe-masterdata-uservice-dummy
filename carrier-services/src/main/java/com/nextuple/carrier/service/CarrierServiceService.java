...
import com.nextuple.carrier.config.CarrierOptionConfig;
...
public class CarrierServiceService {
  ...
  private final CarrierOptionConfig carrierOptionConfig;
  ...
  public CarrierServiceResponse createCarrierService(CarrierServiceRequest carrierServiceRequest)
    ...
    if (!carrierOptionConfig.serviceOptions.contains(carrierServiceRequest.getServiceOptions())) {
      logger.error("Invalid Service Option");
      Map<String, FieldError> errorMap = new HashMap<>();
      errorMap.put(
          SERVICE_OPTIONS,
          FieldError.builder().rejectedValue(carrierServiceRequest.getServiceOptions()).build());
