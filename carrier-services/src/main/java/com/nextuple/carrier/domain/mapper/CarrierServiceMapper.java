...
public interface CarrierServiceMapper {
  CarrierServiceDomainDto carrierServiceRequestToCarrierServiceDomainDto(
      CarrierServiceRequest carrierServiceRequest);

  CarrierServiceResponse toCarrierServiceResponse(CarrierServiceDomainDto carrierServiceDomainDto);
