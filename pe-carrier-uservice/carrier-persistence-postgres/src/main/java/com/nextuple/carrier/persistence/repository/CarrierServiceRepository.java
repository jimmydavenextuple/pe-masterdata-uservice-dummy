...
package com.nextuple.carrier.persistence.repository;
...
@Repository
public interface CarrierServiceRepository
    extends CommonJpaRepository<CarrierServiceEntity, CarrierServiceKey> {
