...
package com.nextuple.carrier.consumer.config;
...
public class CarrierConsumerConfig {
  ...
  public ConcurrentKafkaListenerContainerFactory<String, Object> kafkaListenerContainerFactoryJSON(
      ...
      ConsumerFactory<String, Object> carrierConsumer) {

    ConcurrentKafkaListenerContainerFactory<String, Object> factory =
        new ConcurrentKafkaListenerContainerFactory<>();
    factory.setConsumerFactory(carrierConsumer);
        ...
        new DeadLetterPublishingRecoverer(
            ...
            (cr, e) -> {
              String resolvedTopicName =
                  carrierDltTopic != null ? carrierDltTopic : cr.topic() + ".DLT";
