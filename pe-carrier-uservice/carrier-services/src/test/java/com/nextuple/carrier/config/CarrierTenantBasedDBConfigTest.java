...
class CarrierTenantBasedDBConfigTest {

  @InjectMocks CarrierTenantBasedDBConfig carrierTenantBasedDBConfig;
  ...
  void getServiceOptionsHappyPathTest() throws CommonServiceException {
    ...
    Set<String> response = carrierTenantBasedDBConfig.getServiceOptions(TestUtil.ORG_ID);
  ...
  void getServiceOptionsExceptionTest() throws CommonServiceException {
    ...
    CommonServiceException exception =
        assertThrows(
            ...
            () -> carrierTenantBasedDBConfig.getServiceOptions(TestUtil.ORG_ID));
