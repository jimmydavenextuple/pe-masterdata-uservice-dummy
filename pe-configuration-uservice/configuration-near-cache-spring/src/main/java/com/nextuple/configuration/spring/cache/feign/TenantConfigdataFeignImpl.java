...
package com.nextuple.configuration.spring.cache.feign;
...
public interface TenantConfigdataFeignImpl
    extends GenericFeignService<String, BaseResponse<TenantConfigdataResponse>> {

  @GetMapping("/tenant-configuration/get")
  BaseResponse<TenantConfigdataResponse> get(String request);
