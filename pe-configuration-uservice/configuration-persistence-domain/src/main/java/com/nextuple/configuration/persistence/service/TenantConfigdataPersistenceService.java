...
@Service
public interface TenantConfigdataPersistenceService
    extends DomainPersistenceService<TenantConfigdataDomainDto, TenantConfigdataDomainKey> {

  TenantConfigdataDomainDto saveTenantConfigdata(
      TenantConfigdataDomainDto tenantConfigdataDomainDto) throws PromiseEngineException;

  Optional<TenantConfigdataDomainDto> fetchTenantConfigdataByOrgIdAndConfigKey(
      String orgId, String configKey) throws PromiseEngineException;

  void deleteTenantConfigdata(TenantConfigdataDomainDto tenantConfigdataDomainDto)
