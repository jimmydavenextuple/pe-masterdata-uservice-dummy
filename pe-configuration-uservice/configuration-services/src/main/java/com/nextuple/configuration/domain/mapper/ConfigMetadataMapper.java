...
public interface ConfigMetadataMapper {
  ...
  ConfigMetadataEntity toConfigMetadataEntity(ConfigMetadataRequest configMetadataRequest);

  ConfigMetadataResponse toConfigMetadataResponse(ConfigMetadataEntity configMetadataEntity);

  void updateConfigMetadataEntity(
      ConfigMetadataUpdateRequest configMetadataUpdateRequest,
      @MappingTarget ConfigMetadataEntity configMetadataEntity);
}
