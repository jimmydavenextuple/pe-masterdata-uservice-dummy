...
public interface TenantConfigdataMapper {
  ...
  TenantConfigdataEntity toTenantConfigdataEntity(TenantConfigdataRequest tenantConfigdataRequest);

  TenantConfigdataResponse toTenantConfigdataResponse(
      TenantConfigdataEntity tenantConfigdataEntity);

  void updateTenantConfigdata(
      TenantConfigdataUpdateRequest tenantConfigdataUpdateRequest,
      @MappingTarget TenantConfigdataEntity tenantConfigdataEntity);
}
