...
public interface NodeFeign {
  ...
  @GetMapping("/node/{orgId}/v2")
  BaseResponse<PagePayload<NodeDto>> getNodeListV2(
      @NotBlank @PathVariable String orgId,
  ...
  @GetMapping("/node/node-types/{orgId}")
  BaseResponse<NodeTypesResponse> getNodeTypesList(@NotBlank @PathVariable String orgId);
}
