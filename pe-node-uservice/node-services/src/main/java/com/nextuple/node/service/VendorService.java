...
import com.nextuple.node.domain.mapper.VendorMapper;
...
public class VendorService {
  ...
  public VendorResponse updateVendorDetails(
    ...
    logger.info("Response before updation of node :{}", existingVendorDetails.get());
  ...
  public VendorResponse deleteVendor(String vendorId, String orgId)
    ...
    logger.info(
        "Response before deletion of node :{}", INSTANCE.toVendorResponse(vendorDetails.get()));
