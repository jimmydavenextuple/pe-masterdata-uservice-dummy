...
public interface NodeMapper {
  ...
  NodeDomainDto nodeRequestToNodeEntity(NodeRequest nodeRequest);
  ...
  NodeDto toNodeDto(NodeDomainDto node);

  List<NodeCacheKeyDto> toNodeCacheKeyResponseList(List<NodeDomainDto> nodeEntities);
}
