...
class NodeFeedConsumerTest {

  @InjectMocks private NodeFeedConsumer nodeFeedConsumer;
  @Mock private NodeBatchServiceImpl nodeBatchService;
  ...
  void consumeMasterDataFeedTest() {
    ...
    when(nodeBatchService.processRecordsWithRetry(any())).thenReturn(batchResponse);
    nodeFeedConsumer.consumeNodeFeed(nodeFeedRequests, null);

    verify(nodeBatchService, times(1)).processRecordsWithRetry(any());
  }
}
