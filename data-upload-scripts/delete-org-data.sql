...
DELETE FROM "node_carriers" WHERE ORG_ID = 'ORGID';
DELETE FROM "rules_configuration" WHERE ORG_ID = 'ORGID';
DELETE FROM "node_service_option" WHERE ORG_ID = 'ORGID';
DELETE FROM "node_service_option_buffers" WHERE ORG_ID = 'ORGID';
DELETE FROM "holiday_cutoff" WHERE ORG_ID = 'ORGID';
