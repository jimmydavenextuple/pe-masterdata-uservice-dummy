...
public class NodeCarrierCalendarSpringNearCacheService
  ...
  private static final Logger logger = LoggerFactory.getLogger(NodeCarrierCalendarSpringNearCacheService.class);
  ...
  public NodeCarrierCalendarCacheValue get(NodeCarrierCalendarCacheKey key) {
    logger.info("Inside get NodeCarrierCalendarCacheValue");
