...
class CarrierServiceCalendarServiceTest {
  ...
  @Test
  void processCreateCarrierServiceCalendarTest() throws CalendarDomainException, CommonServiceException {
  ...
  void processValidateCalendarIdTestException() throws CalendarDomainException, CommonServiceException {
    ...
    Assertions.assertEquals("Cannot create a carrier service calendar as calendarId/orgId is invalid", exception.getMessage());
    verify(calendarDomain, times(1)).getCalendar(any(), any());
  }
