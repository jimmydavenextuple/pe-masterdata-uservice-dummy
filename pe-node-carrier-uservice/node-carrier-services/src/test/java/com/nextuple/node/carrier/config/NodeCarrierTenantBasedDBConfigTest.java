...
package com.nextuple.node.carrier.config;
...
class NodeCarrierTenantBasedDBConfigTest {

  @InjectMocks NodeCarrierTenantBasedDBConfig nodeCarrierTenantBasedDBConfig;
  ...
  void getServiceOptionsHappyPathTest() throws CommonServiceException {
    ...
    Set<String> response = nodeCarrierTenantBasedDBConfig.getServiceOptions(TestUtil.ORG_ID);
  ...
  void getServiceOptionsExceptionTest() throws CommonServiceException {
    ...
    CommonServiceException exception =
        assertThrows(
            ...
            () -> nodeCarrierTenantBasedDBConfig.getServiceOptions(TestUtil.ORG_ID));
