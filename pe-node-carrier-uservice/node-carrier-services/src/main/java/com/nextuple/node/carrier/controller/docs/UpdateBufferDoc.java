...
@Inherited
@Operation(summary = "Update Buffer Details", description = NodeCarrierConstants.UPDATE_BUFFER_DESC)
@ApiResponse(
    responseCode = "200",
    description = "A 200 success code indicates that the buffer details are updated successfully.")
@ApiResponse(
    responseCode = "400",
    description =
            ...
            examples = {
              @ExampleObject(
                  ...
                  value =
                      "{\n"
                          + "    \"success\": false,\n"
                          + "    \"requestId\": \"db8b5231-9ee1-4014-bc0e-c4b55e4d5c5c#365\",\n"
                          + "    \"timestamp\": 1679896213085,\n"
...
public @interface UpdateBufferDoc {}
