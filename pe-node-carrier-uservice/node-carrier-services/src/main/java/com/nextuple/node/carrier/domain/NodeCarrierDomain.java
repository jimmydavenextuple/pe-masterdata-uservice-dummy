...
public class NodeCarrierDomain {
  ...
  public List<NodeCarrierEntity> getAllNodeCarriersByOrgIdCarrierServiceId(
      String orgId, String carrierServiceId) throws NodeCarrierDomainException {
    try {
      return nodeCarrierRepository.findByOrgIdAndCarrierServiceId(orgId, carrierServiceId);
    } catch (Exception e) {
      logger.error(
          String.valueOf(e), "Unable to find node carrier details by orgId and carrierServiceId");
      throw new NodeCarrierDomainException(
