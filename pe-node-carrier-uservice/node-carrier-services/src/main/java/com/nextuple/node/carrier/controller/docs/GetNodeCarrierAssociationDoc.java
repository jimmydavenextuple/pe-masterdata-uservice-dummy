...
@Operation(
    ...
    description = NodeCarrierConstants.GET_NODE_CARRIER_LIST_BY_NODEID_ORGID_SO_DESC)
@ApiResponse(
    responseCode = "200",
    description =
        "A 200 success code indicates that the node-carrier association details list is retrieved successfully.")
@ApiResponse(
    responseCode = "400",
    description =
        "A 400 error code indicates that the request to retrieve node-carrier association details list is not valid.")
@ApiResponse(
    responseCode = "404",
    description =
            ...
            examples = {
              @ExampleObject(
                  ...
                  value =
                      "{\n"
                          + "    \"success\": false,\n"
                          + "    \"requestId\": \"4811dcb1-881e-4223-ae6e-69a05a118c9e#483\",\n"
                          + "    \"timestamp\": 1679891574023,\n"
...
public @interface GetNodeCarrierAssociationDoc {}
