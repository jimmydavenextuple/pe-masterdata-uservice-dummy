...
public interface NodeServiceOptionMapper {
  NodeServiceOptionEntity nodeServiceOptionRequestToEntity(
      NodeServiceOptionRequest nodeServiceOptionRequest);

  NodeServiceOptionResponse toNodeServiceOptionResponse(
      NodeServiceOptionEntity nodeServiceOptionEntity);

  List<NodeServiceOptionResponse> toNodeServiceOptionResponseList(
      List<NodeServiceOptionEntity> nodeServiceOptionEntity);

  NodeServiceOptionEntity toUpdateNodeServiceOption(
      NodeServiceOptionUpdateRequest nodeServiceOptionUpdateRequest,
      @MappingTarget NodeServiceOptionEntity nodeServiceOptionEntity);
}
