...
public interface NodeCarriersMapper {

  NodeCarriersEntity nodeCarriersRequestToEntity(NodeCarriersRequest nodeCarriersRequest);

  NodeCarriersResponse toNodeCarriersResponse(NodeCarriersEntity nodeCarriersEntity);

  List<NodeCarriersResponse> toNodeCarriersResponseList(
      List<NodeCarriersEntity> nodeCarriersEntity);

  NodeCarriersEntity updateNodeCarrierEntity(
      NodeCarriersUpdateRequest nodeCarriersUpdateRequest,
      @MappingTarget NodeCarriersEntity nodeCarriersEntity);

  List<NodeCarrierListCacheKeyDto> toNodeCarriersCacheKeyDto(
