...
@Inherited
@Operation(
    summary = "Create Node-Carrier Association",
    description = NodeCarrierConstants.CREATE_NODE_DESC)
@ApiResponse(
    responseCode = "200",
    description =
        "A 200 success code indicates that the node-carrier association is created successfully.")
@ApiResponse(
    responseCode = "400",
    description =
              ...
              @ExampleObject(
                  ...
                  value =
                      "{\n"
                          ...
                          + "}"),
              @ExampleObject(
                  summary = "Node Id is not passed.",
                  name =
                      "A 400 error code indicates that the node ID is not passed and it is a mandatory field.",
                  value =
                      "{\n"
                          + "    \"success\": false,\n"
                          + "    \"timestamp\": 1670588798304,\n"
...
public @interface CreateNodeCarrierDoc {}
