...
@NoArgsConstructor
@SuperBuilder
public class NodeServiceOptionBufferRequest extends AdditionalAttributes implements Serializable {
  private static final long serialVersionUID = -5812315809620272913L;
  ...
  @NotNull(message = "bufferStartDate cannot be empty")
