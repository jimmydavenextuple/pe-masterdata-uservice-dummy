...
@AllArgsConstructor
@SuperBuilder
public class NodeServiceOptionBufferResponse extends AdditionalAttributes implements Serializable {

  private static final long serialVersionUID = -1378888917280769528L;

  @Schema(description = NodeCarrierConstants.ID, example = NodeCarrierConstants.ID_EXAMPLE)
  private Long id;
