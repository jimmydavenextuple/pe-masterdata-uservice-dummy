...
@NoArgsConstructor
@SuperBuilder
public class NodeCarrierSelectionRequest extends AdditionalAttributes implements Serializable {
  ...
  @Schema(description = "Priority given to the node-carrier association", example = "0")
