...
@NoArgsConstructor
@SuperBuilder
public class NodeServiceOptionRequest extends AdditionalAttributes implements Serializable {

  private static final long serialVersionUID = 5280469755292325629L;
  ...
  @NotNull(message = "processingTime cannot be null or empty")
