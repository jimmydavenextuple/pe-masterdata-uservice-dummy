...
public interface NodeCarriersFeignImpl
    extends GenericFeignService<String, BaseResponse<List<NodeCarriersResponse>>> {

  @GetMapping("v2/node/carrier/get")
  BaseResponse<List<NodeCarriersResponse>> get(String request);
