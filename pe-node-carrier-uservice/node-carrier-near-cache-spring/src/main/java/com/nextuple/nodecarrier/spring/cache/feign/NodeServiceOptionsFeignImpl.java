...
public interface NodeServiceOptionsFeignImpl
    extends GenericFeignService<String, BaseResponse<NodeServiceOptionResponse>> {

  @GetMapping("v2/node/service-option/get")
  BaseResponse<NodeServiceOptionResponse> get(String request);
