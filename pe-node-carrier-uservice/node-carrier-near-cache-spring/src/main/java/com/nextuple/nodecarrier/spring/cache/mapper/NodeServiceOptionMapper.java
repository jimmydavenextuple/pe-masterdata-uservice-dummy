...
@Component
public class NodeServiceOptionMapper
  ...
  @Override
  public NodeServiceOptionCacheKey requestToCacheKey(String request) {
    return null;
  }

  @Override
  public String cacheKeyToRequest(NodeServiceOptionCacheKey cacheKey) {
    return null;
  }

  @Override
  public NodeServiceOptionCacheValue responseToCacheValue(
      BaseResponse<NodeServiceOptionResponse> resp) {
    return NodeServiceOptionCacheValue.builder()
        .nodeServiceOptionResponse(resp.getPayload())
        .build();
  }

  @Override
  public BaseResponse<NodeServiceOptionResponse> cacheValueToResponse(
      NodeServiceOptionCacheValue cacheValue) {
    return null;
  }
}
