...
class NodeServiceOptionBufferMapperTest {
  @InjectMocks private NodeServiceOptionBufferMapper mapper;
  ...
  void cacheKeyToRequest() {
    assertNull(mapper.cacheKeyToRequest(testUtil.getNodeServiceOptionBufferCacheKey()));
  }

  @Test
  void responseToCacheValue() {
    NodeServiceOptionBufferCacheValue nodeCarrierCacheValue =
        testUtil.getNodeServiceOptionBufferCacheValue();

    BaseResponse<List<NodeServiceOptionBufferResponse>> response =
  ...
  void cacheValueToResponse() {
    assertNull(mapper.cacheValueToResponse(testUtil.getNodeServiceOptionBufferCacheValue()));
  }
}
