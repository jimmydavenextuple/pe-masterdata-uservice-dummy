...
class NodeCarrierSelectionMapperTest {
  @InjectMocks private NodeCarrierSelectionMapper mapper;
  ...
  void cacheKeyToRequest() {
    assertNull(mapper.cacheKeyToRequest(testUtil.getNodeCarrierSelectionCacheKey()));
  }

  @Test
  void responseToCacheValue() {
    NodeCarrierSelectionCacheValue nodeCarrierCacheValue =
        testUtil.getNodeCarrierSelectionCacheValue();

    BaseResponse<List<NodeCarrierSelectionResponse>> response =
        testUtil.getNodeCarrierSelectionResponse();
  ...
  void cacheValueToResponse() {
    assertNull(mapper.cacheValueToResponse(testUtil.getNodeCarrierSelectionCacheValue()));
  }
}
