...
class ProcessingLeadTimeConsumerTest {

  @InjectMocks private ProcessingLeadTimeConsumer processingLeadTimeConsumer;
  @Mock private ProcessingLeadTimeBatchServiceImpl processingLeadTimeBatchService;
  @InjectMocks private TestUtil testUtil;

  @Test
  @DisplayName("When the processing lead time feed gets consumed successfully.")
  void consumeMasterDataFeedTest() {
    List<BatchRequest<ProcessingLeadTimeFeedDto>> processingLeadTimeFeedRequest =
    ...
    when(processingLeadTimeBatchService.processRecordsWithRetry(any())).thenReturn(batchResponse);
    processingLeadTimeConsumer.consumeMasterDataFeed(processingLeadTimeFeedRequest, null);

    verify(processingLeadTimeBatchService, times(1)).processRecordsWithRetry(any());
  }
}
