...
public class ProcessingLeadTimeConsumer extends MasterDataFeedConsumer<ProcessingLeadTimeFeedDto> {
  ...
  private final TypeReference<List<BatchRequest<ProcessingLeadTimeFeedDto>>>
  ...
  public void invokeFeedProcessingService(
      List<BatchRequest<ProcessingLeadTimeFeedDto>> processingLeadTimeFeed) {
    processingLeadTimeBatchService.processRecordsWithRetry(processingLeadTimeFeed);
  }
