...
@AllArgsConstructor
@SuperBuilder
public class ProcessingLeadTimeFeedDto extends CommonMasterDataFieldsDto implements Serializable {

  @Serial private static final long serialVersionUID = -6409534485320437365L;
