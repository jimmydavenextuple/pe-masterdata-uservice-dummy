...
public class NodeServiceOptionBufferFeedConsumer
  ...
  private final TypeReference<List<BatchRequest<NodeServiceOptionBufferFeedDto>>>
  ...
  public void invokeFeedProcessingService(
      List<BatchRequest<NodeServiceOptionBufferFeedDto>> nodeServiceOptionBufferFeed) {
    nodeServiceOptionBufferBatchService.processRecordsWithRetry(nodeServiceOptionBufferFeed);
  }
