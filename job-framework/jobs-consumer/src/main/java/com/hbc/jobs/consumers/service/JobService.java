...
public class JobService {
  ...
  public void updateJob(RecordStatusDto recordStatusDto, int retryCount) throws JobException {
    try {
      ...
      JobEntity updateJobEntity = processJobStatus(jobEntity, recordStatusDto);
  ...
  public JobDto createJob(JobDto jobDto) throws JobException {
    ...
    try {
      ...
      JobEntity jobEntity = jobDomain.save(JobMapper.INSTANCE.toJobEntity(jobDto));
  ...
  public JobDto getJob(String jobId, String orgId) throws JobException {
    ...
    try {
      JobEntity jobEntity = jobDomain.findJobByJobIdAndOrgId(jobId, orgId);
