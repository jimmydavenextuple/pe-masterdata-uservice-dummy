...
class NodeCarrierDataUploadUtilityServiceTest {
  ...
  void uploadNodeCarrierDataSuccessTest() throws CommonServiceException, IOException {
    ...
    Assertions.assertEquals("Node Carrier Data successfully uploaded!", response.getBody().getMessage());
  }
  ...
  void uploadNodeCarrierInvalidHeadersExceptionTest() {
    ...
    Assertions.assertEquals("Node Carrier data uploaded file has invalid headers.", exception.getMessage());
  ...
  void uploadNodeCarrierInvalidFileTypeExceptionTest() {
    ...
    Assertions.assertEquals("Node Carrier data uploaded file is not a csv file.", exception.getMessage());
    Assertions.assertEquals(HttpStatus.BAD_REQUEST, exception.getHttpStatus());
  }
  ...
  void uploadNodeCarrierEmptyRecordsExceptionTest() {
    ...
    Assertions.assertEquals("Node Carrier data uploaded file has no records.", exception.getMessage());
    Assertions.assertEquals(HttpStatus.BAD_REQUEST, exception.getHttpStatus());
  }
