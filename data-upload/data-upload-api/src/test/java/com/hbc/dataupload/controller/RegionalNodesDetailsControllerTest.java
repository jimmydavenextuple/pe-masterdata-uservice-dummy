...
class RegionalNodesDetailsControllerTest {
    ...
    @InjectMocks
    private RegionalNodesDetailsController regionalNodesDetailsController;

    @Mock
    private RegionalNodesDetailsService regionalNodesDetailsService;
    ...
    void getNodesListTest() {
        ...
        verify(regionalNodesDetailsService, times(1))
