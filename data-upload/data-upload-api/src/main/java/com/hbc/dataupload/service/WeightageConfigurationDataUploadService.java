...
public class WeightageConfigurationDataUploadService {
  ...
  public ResponseEntity<BaseResponse<String>> uploadWeightageConfigurationData(String fileUri)
    ...
    List<String> expectedHeaders =
        DataUploadUtilityExpectedHeaders.getCSVExpectedHeaders("weightageConfiguration");
    ...
    if (!FILE_TYPE.equals(Files.probeContentType(path))) {
      ...
      throw new CommonServiceException(
          WEIGHTAGE_CONFIGURATION_DATA_UPLOAD_INVALID_FILE_TYPE,
    ...
    if (sizeOfFileInKiloBytes > maxSizeInKiloBytes) {
      ...
      errorMap.put(
          ...
          FieldError.builder()
              ...
              .build());
      throw new CommonServiceException(
          WEIGHTAGE_CONFIGURATION_DATA_UPLOAD_LARGE_FILE_SIZE,
          HttpStatus.BAD_REQUEST,
          0x2774,
          errorMap);
    }
    ...
    if (numberOfRowsInFile < 2) {
      ...
      errorMap.put(FILE_URI, FieldError.builder().rejectedValue(fileUri).build());
      throw new CommonServiceException(
          WEIGHTAGE_CONFIGURATION_DATA_UPLOAD_FILE_EMPTY_RECORDS,
          HttpStatus.BAD_REQUEST,
          0x2775,
          errorMap);
    }
    ...
    if (numberOfRowsInFile > maxRows) {
      ...
      errorMap.put(
          ...
          FieldError.builder()
              ...
              .build());
      throw new CommonServiceException(
          WEIGHTAGE_CONFIGURATION_DATA_UPLOAD_LARGE_ROW_SIZE,
          HttpStatus.BAD_REQUEST,
          0x2776,
          errorMap);
    }
