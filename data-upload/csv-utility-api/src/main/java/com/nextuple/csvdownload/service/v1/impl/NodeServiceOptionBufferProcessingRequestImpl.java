...
import static com.nextuple.dataupload.common.constants.CommonDataUploadErrorConstants.NODE_SERVICE_OPTION_BUFFER_DATA_UPLOAD_INVALID_FILE_HEADERS;
import static com.nextuple.dataupload.common.constants.CommonDataUploadErrorConstants.NODE_SERVICE_OPTION_BUFFER_DATA_UPLOAD_INVALID_FILE_TYPE;
...
public class NodeServiceOptionBufferProcessingRequestImpl extends AbstractProcessingRequest {
  ...
  public String getModuleType() {
    return ModuleEnum.NODE_SERVICE_OPTION_BUFFER.getModuleValue();
  }

  @Override
  public String submitJob(String orgId, long fileMetadataId) throws JobSubmissionException {
    return submitJob(orgId, JobTypeEnum.UPLOAD_NODE_SERVICE_OPTION_BUFFER, fileMetadataId)
        .getJobId();
  }
  ...
  public void validate(GenericUploadRequest request, FileResponse fileResponse)
    ...
    DataUploadUtil.validateFileType(
        fileResponse.getContentType(), NODE_SERVICE_OPTION_BUFFER_DATA_UPLOAD_INVALID_FILE_TYPE);
