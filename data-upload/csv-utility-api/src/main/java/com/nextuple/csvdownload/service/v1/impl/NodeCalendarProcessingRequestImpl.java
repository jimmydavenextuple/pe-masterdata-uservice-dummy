...
import static com.nextuple.dataupload.common.constants.CommonDataUploadErrorConstants.NODE_CALENDER_DATA_UPLOAD_INVALID_FILE_HEADERS;
import static com.nextuple.dataupload.common.constants.CommonDataUploadErrorConstants.NODE_CALENDER_DATA_UPLOAD_INVALID_FILE_TYPE;
...
@Service
public class NodeCalendarProcessingRequestImpl extends AbstractProcessingRequest {

  @Value("${download-page-size.node-carrier-service-options}")
  private Integer noOfRecordsPerPage;

  public NodeCalendarProcessingRequestImpl(
  ...
  public String getModuleType() {
    return ModuleEnum.NODE_CALENDAR.getModuleValue();
  }

  @Override
  public String submitJob(String orgId, long fileMetadataId) throws JobSubmissionException {
    return submitJob(orgId, JobTypeEnum.UPLOAD_NODE_CALENDER, fileMetadataId).getJobId();
  }
  ...
  public void validate(GenericUploadRequest request, FileResponse fileResponse)
    ...
    DataUploadUtil.validateFileType(
        fileResponse.getContentType(), NODE_CALENDER_DATA_UPLOAD_INVALID_FILE_TYPE);
    ...
    DataUploadUtil.validateCSVHeaders(
        ...
        getModuleType(),
        NODE_CALENDER_DATA_UPLOAD_INVALID_FILE_HEADERS,
        csvReader);
  ...
  public void addErrorLine(CSVWriter writer, List<RecordStatusDto> recordStatusDtos)
      throws IOException {
    recordStatusDtos.forEach(dto -> constructNodeCalendarError(writer, dto));
    writer.flush();
  }

  private void constructNodeCalendarError(CSVWriter writer, RecordStatusDto recordStatusDto) {
    var gson = new Gson();
    var requestBody = gson.fromJson(recordStatusDto.getRequestBody(), NodeCalendarUpload.class);
