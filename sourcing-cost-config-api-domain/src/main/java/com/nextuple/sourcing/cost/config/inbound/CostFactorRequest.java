...
public class CostFactorRequest implements Serializable {
  ...
  @Schema(description = "Cost Factor", example = "BillWeightUps")
  private String costFactor;

  @NotNull(message = "Data type of cost factor can't be null")
  @Schema(description = "Data type of cost factor", example = "NUMBER")
  private DataTypeEnum dataType;

  @NotBlank(message = "Formula to determine cost factor can't be empty")
  ...
  @NotNull(
      message =
          "Identifier to determine whether the cost factor is derived or regular can't be null")
  @Schema(
  ...
  @NotBlank(message = "Display name of cost factor can't be empty")
  ...
  @NotBlank(message = "Unit of measure can't be empty")
  @Schema(description = "Unit of measure of cost factor", example = "lbs")
  private String uom;

  @NotNull(message = "Boolean value to determine cost factor bucketing can't be null")
  @Schema(
