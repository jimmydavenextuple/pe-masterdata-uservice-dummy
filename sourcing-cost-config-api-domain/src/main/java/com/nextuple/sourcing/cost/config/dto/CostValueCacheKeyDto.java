...
@AllArgsConstructor
@Builder
public class CostValueCacheKeyDto implements Serializable {
  private static final long serialVersionUID = 4531843216195421022L;
  ...
  @Schema(description = "cost factor combination key", example = "SHIPPING_COST|123")
