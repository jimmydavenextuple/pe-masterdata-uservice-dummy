...
public interface TenantCostTypeFeign {
  ...
  @GetMapping("/cost-config/type/get-all-cache-keys")
  BaseResponse<List<TenantCostTypeCacheKeyDto>> getTenantCostTypeCacheKeys(
