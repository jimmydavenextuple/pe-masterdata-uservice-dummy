...
public interface NodeServiceOptionBufferBatchMapper {
  NodeServiceOptionBufferRequest toNodeServiceOptionBufferRequest(
      NodeServiceOptionBufferFeedDto nodeServiceOptionBufferDto);

  NodeServiceOptionBufferDeleteRequest toNodeServiceOptionBufferDeleteRequest(
      NodeServiceOptionBufferFeedDto nodeServiceOptionBufferDto);
}
