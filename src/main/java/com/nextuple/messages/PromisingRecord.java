...
public class PromisingRecord extends org.apache.avro.specific.SpecificRecordBase
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
      ...
      case 31:
        ...
        break;
      case 32:
        sdndEligibleForDC = (Boolean) value$;
        break;
      case 33:
  ...
  /**
   * Gets the value of the 'sdndEligibleForDC' field.
   *
   * @return The value of the 'sdndEligibleForDC' field.
   */
  public Boolean getSdndEligibleForDC() {
    return sdndEligibleForDC;
  }

  /**
   * Sets the value of the 'sdndEligibleForDC' field.
   *
   * @param value the value to set.
   */
  public void setSdndEligibleForDC(Boolean value) {
    this.sdndEligibleForDC = value;
  }

  /**
   * Gets the value of the 'nextdayEligibleForDC' field.
   *
   * @return The value of the 'nextdayEligibleForDC' field.
   */
  public Boolean getNextdayEligibleForDC() {
    return nextdayEligibleForDC;
  }

  /**
   * Sets the value of the 'nextdayEligibleForDC' field.
   *
   * @param value the value to set.
   */
  public void setNextdayEligibleForDC(Boolean value) {
    this.nextdayEligibleForDC = value;
  }
  ...
  public static class Builder
    ...
    private Builder(Builder other) {
      ...
      if (isValidValue(fields()[31], other.nextdayEligible)) {
        this.nextdayEligible = data().deepCopy(fields()[31].schema(), other.nextdayEligible);
        fieldSetFlags()[31] = true;
      }
      if (isValidValue(fields()[32], other.sdndEligibleForDC)) {
        this.sdndEligibleForDC = data().deepCopy(fields()[32].schema(), other.sdndEligibleForDC);
        fieldSetFlags()[32] = true;
      }
      if (isValidValue(fields()[33], other.nextdayEligibleForDC)) {
     ...
     *
     * @param record The existing instance to copy.
     */
    private Builder(PromisingRecord record) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], record.itemId)) {
        this.itemId = data().deepCopy(fields()[0].schema(), record.itemId);
        fieldSetFlags()[0] = true;
      }
      if (isValidValue(fields()[1], record.itemSource)) {
        this.itemSource = data().deepCopy(fields()[1].schema(), record.itemSource);
        fieldSetFlags()[1] = true;
      }
      if (isValidValue(fields()[2], record.orgId)) {
        this.orgId = data().deepCopy(fields()[2].schema(), record.orgId);
        fieldSetFlags()[2] = true;
      }
      if (isValidValue(fields()[3], record.uom)) {
        this.uom = data().deepCopy(fields()[3].schema(), record.uom);
        fieldSetFlags()[3] = true;
      }
      if (isValidValue(fields()[4], record.isDSVEligible)) {
        this.isDSVEligible = data().deepCopy(fields()[4].schema(), record.isDSVEligible);
        fieldSetFlags()[4] = true;
      }
      if (isValidValue(fields()[5], record.product)) {
        this.product = data().deepCopy(fields()[5].schema(), record.product);
        fieldSetFlags()[5] = true;
      }
      if (isValidValue(fields()[6], record.color)) {
        this.color = data().deepCopy(fields()[6].schema(), record.color);
        fieldSetFlags()[6] = true;
      }
      if (isValidValue(fields()[7], record.size)) {
        this.size = data().deepCopy(fields()[7].schema(), record.size);
        fieldSetFlags()[7] = true;
      }
      if (isValidValue(fields()[8], record.shipAlone)) {
        this.shipAlone = data().deepCopy(fields()[8].schema(), record.shipAlone);
        fieldSetFlags()[8] = true;
      }
      if (isValidValue(fields()[9], record.shipEligible)) {
        this.shipEligible = data().deepCopy(fields()[9].schema(), record.shipEligible);
        fieldSetFlags()[9] = true;
      }
      if (isValidValue(fields()[10], record.parcelShipmentEligible)) {
        this.parcelShipmentEligible =
            data().deepCopy(fields()[10].schema(), record.parcelShipmentEligible);
        fieldSetFlags()[10] = true;
      }
      if (isValidValue(fields()[11], record.bopisEligible)) {
        this.bopisEligible = data().deepCopy(fields()[11].schema(), record.bopisEligible);
        fieldSetFlags()[11] = true;
      }
      if (isValidValue(fields()[12], record.expressEligible)) {
        this.expressEligible = data().deepCopy(fields()[12].schema(), record.expressEligible);
        fieldSetFlags()[12] = true;
      }
      if (isValidValue(fields()[13], record.sdndEligible)) {
        this.sdndEligible = data().deepCopy(fields()[13].schema(), record.sdndEligible);
        fieldSetFlags()[13] = true;
      }
      if (isValidValue(fields()[14], record.isWhiteGlove)) {
        this.isWhiteGlove = data().deepCopy(fields()[14].schema(), record.isWhiteGlove);
        fieldSetFlags()[14] = true;
      }
      if (isValidValue(fields()[15], record.height)) {
        this.height = data().deepCopy(fields()[15].schema(), record.height);
        fieldSetFlags()[15] = true;
      }
      if (isValidValue(fields()[16], record.width)) {
        this.width = data().deepCopy(fields()[16].schema(), record.width);
        fieldSetFlags()[16] = true;
      }
      if (isValidValue(fields()[17], record.length)) {
        this.length = data().deepCopy(fields()[17].schema(), record.length);
        fieldSetFlags()[17] = true;
      }
      if (isValidValue(fields()[18], record.volume)) {
        this.volume = data().deepCopy(fields()[18].schema(), record.volume);
        fieldSetFlags()[18] = true;
      }
      if (isValidValue(fields()[19], record.dimensionUom)) {
        this.dimensionUom = data().deepCopy(fields()[19].schema(), record.dimensionUom);
        fieldSetFlags()[19] = true;
      }
      if (isValidValue(fields()[20], record.volumeUom)) {
        this.volumeUom = data().deepCopy(fields()[20].schema(), record.volumeUom);
        fieldSetFlags()[20] = true;
      }
      if (isValidValue(fields()[21], record.weight)) {
        this.weight = data().deepCopy(fields()[21].schema(), record.weight);
        fieldSetFlags()[21] = true;
      }
      if (isValidValue(fields()[22], record.weightUOM)) {
        this.weightUOM = data().deepCopy(fields()[22].schema(), record.weightUOM);
        fieldSetFlags()[22] = true;
      }
      if (isValidValue(fields()[23], record.processingTime)) {
        this.processingTime = data().deepCopy(fields()[23].schema(), record.processingTime);
        fieldSetFlags()[23] = true;
      }
      if (isValidValue(fields()[24], record.cost)) {
        this.cost = data().deepCopy(fields()[24].schema(), record.cost);
        fieldSetFlags()[24] = true;
      }
      if (isValidValue(fields()[25], record.isHazmat)) {
        this.isHazmat = data().deepCopy(fields()[25].schema(), record.isHazmat);
        fieldSetFlags()[25] = true;
      }
      if (isValidValue(fields()[26], record.shortDescription)) {
        this.shortDescription = data().deepCopy(fields()[26].schema(), record.shortDescription);
        fieldSetFlags()[26] = true;
      }
      if (isValidValue(fields()[27], record.departmentNumber)) {
        this.departmentNumber = data().deepCopy(fields()[27].schema(), record.departmentNumber);
        fieldSetFlags()[27] = true;
      }
      if (isValidValue(fields()[28], record.departmentName)) {
        this.departmentName = data().deepCopy(fields()[28].schema(), record.departmentName);
        fieldSetFlags()[28] = true;
      }
      if (isValidValue(fields()[29], record.imageUrl)) {
        this.imageUrl = data().deepCopy(fields()[29].schema(), record.imageUrl);
        fieldSetFlags()[29] = true;
      }
      if (isValidValue(fields()[30], record.lastModifiedDate)) {
        this.lastModifiedDate = data().deepCopy(fields()[30].schema(), record.lastModifiedDate);
        fieldSetFlags()[30] = true;
      }
      if (isValidValue(fields()[31], record.nextdayEligible)) {
        this.nextdayEligible = data().deepCopy(fields()[31].schema(), record.nextdayEligible);
        fieldSetFlags()[31] = true;
      }
      if (isValidValue(fields()[32], record.sdndEligibleForDC)) {
        this.sdndEligibleForDC = data().deepCopy(fields()[32].schema(), record.sdndEligibleForDC);
        fieldSetFlags()[32] = true;
      }
      if (isValidValue(fields()[33], record.nextdayEligibleForDC)) {
        this.nextdayEligibleForDC =
            data().deepCopy(fields()[33].schema(), record.nextdayEligibleForDC);
        fieldSetFlags()[33] = true;
      }
      if (isValidValue(fields()[34], record.itemBanner)) {
        this.itemBanner = data().deepCopy(fields()[34].schema(), record.itemBanner);
        fieldSetFlags()[34] = true;
      }
    }
     ...
     * Sets the value of the 'sdndEligibleForDC' field.
     *
     * @param value The value of 'sdndEligibleForDC'.
     * @return This builder.
     */
    public Builder setSdndEligibleForDC(Boolean value) {
    ...
    /**
     * Checks whether the 'sdndEligibleForDC' field has been set.
     *
     * @return True if the 'sdndEligibleForDC' field has been set, false otherwise.
     */
    public boolean hasSdndEligibleForDC() {
      return fieldSetFlags()[32];
    }

    /**
     * Clears the value of the 'sdndEligibleForDC' field.
     *
     * @return This builder.
     */
    public Builder clearSdndEligibleForDC() {
      sdndEligibleForDC = null;
     ...
     * Sets the value of the 'nextdayEligibleForDC' field.
     *
     * @param value The value of 'nextdayEligibleForDC'.
     * @return This builder.
     */
    public Builder setNextdayEligibleForDC(Boolean value) {
    ...
    /**
     * Checks whether the 'nextdayEligibleForDC' field has been set.
     *
     * @return True if the 'nextdayEligibleForDC' field has been set, false otherwise.
     */
    public boolean hasNextdayEligibleForDC() {
      return fieldSetFlags()[33];
    }

    /**
     * Clears the value of the 'nextdayEligibleForDC' field.
     *
     * @return This builder.
     */
    public Builder clearNextdayEligibleForDC() {
      nextdayEligibleForDC = null;
      ...
      try {
        ...
        record.nextdayEligible =
            fieldSetFlags()[31]
                ...
                : (Boolean) defaultValue(fields()[31], record.getConversion(31));
        record.sdndEligibleForDC =
            fieldSetFlags()[32]
                ? this.sdndEligibleForDC
                : (Boolean) defaultValue(fields()[32], record.getConversion(32));
        record.nextdayEligibleForDC =
            fieldSetFlags()[33]
                ? this.nextdayEligibleForDC
