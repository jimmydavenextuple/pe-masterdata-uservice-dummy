...
public class KafkaProducerConfigs {
  ...
  public ProducerFactory<String, Object> kafkaJsonProducerFactory() {
    ...
    prop.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, prop.get("bootstrap-servers"));
    ...
    prop.put(
        SaslConfigs.SASL_JAAS_CONFIG, ((Map<String, Object>) saslProps.get("jaas")).get("config"));
