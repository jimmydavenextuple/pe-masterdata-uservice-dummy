...
public class KafkaConsumerConfigs {
  ...
  public ConsumerFactory<Object, Object> stringConsumerFactory() {
    ...
    // securityProps.get("security.protocol"));
    ...
    //    prop.put(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG,
    // kafkaStringProperties.getEnableAutoCommit());
    //    prop.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG,
    // kafkaStringProperties.getAutoOffsetReset());
    return new DefaultKafkaConsumerFactory<>(prop);
  }
