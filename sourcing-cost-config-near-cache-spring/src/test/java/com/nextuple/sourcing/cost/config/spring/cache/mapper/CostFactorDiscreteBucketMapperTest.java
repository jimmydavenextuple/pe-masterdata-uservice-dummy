...
class CostFactorDiscreteBucketMapperTest {
  @InjectMocks
  private GenericMapper<
      ...
      genericMapper = new CostFactorDiscreteBucketMapper();
  ...
  void cacheKeyToRequest() {
    assertNull(genericMapper.cacheKeyToRequest(new CostFactorDiscreteBucketCacheKey()));
  }

  @Test
  void cacheValueToResponse() {
    assertNull(
        genericMapper.cacheValueToResponse(testUtil.getCostFactorDiscreteBucketCacheValue()));
  }
}
