...
public class CostValueMapper
  ...
  @Override
  public CostValueCacheKey requestToCacheKey(String request) {
    return null;
  }

  @Override
  public String cacheKeyToRequest(CostValueCacheKey cacheKey) {
    return null;
  }

  @Override
  public CostValueCacheValue responseToCacheValue(BaseResponse<CostValueResponse> resp) {
    return DATA_MAPPER.toCostValueCacheValue(resp.getPayload());
  }

  @Override
  public BaseResponse<CostValueResponse> cacheValueToResponse(CostValueCacheValue cacheValue) {
    return null;
  }
}
