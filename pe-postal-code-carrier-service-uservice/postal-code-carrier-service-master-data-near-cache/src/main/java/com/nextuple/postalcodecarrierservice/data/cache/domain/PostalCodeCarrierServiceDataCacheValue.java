...
package com.nextuple.postalcodecarrierservice.data.cache.domain;
...
@NoArgsConstructor
@AllArgsConstructor
public class PostalCodeCarrierServiceDataCacheValue implements CacheValue {
  private static final long serialVersionUID = 1240891589171888066L;
  private PostalCodeCarrierServiceResponse postalCodeCarrierServiceResponse;
