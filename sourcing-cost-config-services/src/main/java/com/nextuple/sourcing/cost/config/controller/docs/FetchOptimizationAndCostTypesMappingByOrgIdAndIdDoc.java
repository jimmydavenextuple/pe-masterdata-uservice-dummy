...
@Operation(
    ...
    description = "Retrieves Optimization and Cost Types Mapping By Organization ID and ID.")
@ApiResponse(
    responseCode = "200",
    description =
...
public @interface FetchOptimizationAndCostTypesMappingByOrgIdAndIdDoc {}
