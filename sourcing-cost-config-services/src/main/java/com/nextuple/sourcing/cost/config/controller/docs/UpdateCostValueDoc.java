...
@Inherited
@Operation(summary = "Update Cost Value", description = "Update the cost value with given details.")
@ApiResponse(
    responseCode = "200",
    description = "When cost value is successfully updated.",
    content =
        @Content(
            schema = @Schema(implementation = CostValueResponse.class),
            examples = {
              @ExampleObject(
                  summary = "When cost value is successfully updated.",
                  name = "A 200 response indicates that the cost value is successfully updated.",
                  value =
                      """
                                                {
                                                      "success": true,
              ...
              @ExampleObject(
                  ...
                  value =
                      """
                                            {
                                                  "success": false,
                                                  "requestId": "9e00b5ef-f0e3-4ca7-bde3-45e5a8451d99",
                                                  "timestamp": 1702036507644,
                                                  ...
                                                  "payload": {
                                                      ...
                                                      "fields": {
                                                          ...
                                                          "prevSlabValue": {
                                                              "rejectedValue": "C_FEDEX_GROUND|NON_HOLIDAYS|Z2|L5"
                                                          },
                                                          "costFactorCombinationKey": {
                                                              "rejectedValue": "FedEx-Ground|Zone6|E09"
                                                          }
                                                      }
                                                  }
                                              }
...
public @interface UpdateCostValueDoc {}
