...
@Component
public class RateCardRequestValidationFactory {
  public IRateCardRequestValidation getRateCardRequestValidationFactory(
      SelectorCostFactorInfoDto selector) {
    return ObjectUtils.isEmpty(selector)
        ? new RateCardRequestValidationImpl()
        : new RateCardRequestSelectorValidationImpl();
  }
}
