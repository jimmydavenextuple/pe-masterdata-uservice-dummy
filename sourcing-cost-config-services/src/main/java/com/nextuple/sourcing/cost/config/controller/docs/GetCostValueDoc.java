...
@Inherited
@Operation(summary = "Get Cost Value", description = "Get cost value by orgId and id")
@ApiResponse(
    responseCode = "200",
    description = "When a cost value is successfully fetched for a given orgId and Id.",
    content =
        @Content(
            schema = @Schema(implementation = CostValueResponse.class),
            examples = {
              @ExampleObject(
                  summary = "When a cost value is successfully fetched for a given orgId and Id.",
                  name =
                      "A 200 response indicates that the cost value is successfully fetched for a given orgId and Id.",
                  value =
                      """
                                                {
                                                     "success": true,
                                                     "requestId": "f753238a-d6a0-4695-9e6c-c937b2291473",
                                                     "timestamp": 1702035162142,
                                                     "message": "Cost value fetched successfully.",
                                                     "payload": {
                                                         "id": 4076,
                                                         "orgId": "NEXTUPLE_GR",
                                                         "costItinerary": "TEST_COST_LIKE",
                                                         "costFactorCombinationKey": "FedEx-Ground|Zone20|6AF",
                                                         "costValue": 20.0,
                                                         "prevSlabValue": ""
                                                     }
                                                 }
              ...
              @ExampleObject(
                  ...
                  value =
                      """
                                            {
                                                  "success": false,
                                                  "requestId": "25b8bb79-f08f-4b93-bc93-7a9089cc0f00",
                                                  "timestamp": 1702035122762,
...
public @interface GetCostValueDoc {}
