...
@Slf4j
public class RateCardRequestValidationImpl implements IRateCardRequestValidation {
  ...
  private void validateRowAndColumn(
      ...
      throws CommonServiceException {
    if (Objects.isNull(expectedFactor) && Objects.nonNull(requestFactor)
        || (Objects.nonNull(expectedFactor)
            && !expectedFactor.getCostFactor().equals(requestFactor))) {
  ...
  private void validateFilters(
      ...
      throws CommonServiceException {
    boolean allFiltersValid = costTypeValidationResponse.getCostFactors().isEmpty();
